...
def imprimeDEF():
        ...
        if daadReady:
                print(';', file=f)
                if english:
                        print('; DAAD Ready 0.6.1 specific definitions.', file=f)
                else:
                        print('; Definiciones específicas para DAAD Ready 0.6.1', file=f)
                print(';', file=f)
                if english:
...
def imprimePRO0_DR():
        ...
        print('                SET fDarkF', file=f)
        print('', file=f)
        # 1.0.4b6 Lo que sigue es un copia-pega del PRO 0 de DAAD-Ready 0.6.1 ya que no hay tiempo de hacer una versión específica para Triz2DAAD. Si todo va bien, funcionará.
        if english:
            print('; What follows is essentially a copy-paste from DAAD Ready 0.6.1 PRO 0 template.', file = f)
            print('; Hopefully, it will work!', file = f)
        else:
            print('; Lo que sigue es básicamente un copia-pega de la plantilla del PRO 0 de DAAD Ready 0.6.1', file = f)
...
def imprimePRO6_DR():
        ...
        print('', file=f)
        if english:
            print('; What follows is essentially a copy-paste from DAAD-Ready 0.6.1 routine.', file = f)
            print('; Hopefully, it will work!', file=f)
        else:
            print('; Lo que sigue es básicamente un copia-pega de la rutina de DAAD-Ready 0.6.1', file = f)
            print('; ¡Con suerte, funcionará!', file=f)
        print('', file=f)    
        print('#ifndef "zx128"', file = f)
        print('>', file=f)
...
print()
print('Triz2DAAD versión 1.0.4b8 220608 (c) 2019-22 Pedro Fernández')     
...
if daadReady:
        if english:
                print('-Exporting to a DAADReady 0.6.1 compatible template.')
        else:
                print('-Exportando a una plantilla comnpatible con DAADReady 0.6.1')
        dsf=True
        if statusLine:
                if english:
