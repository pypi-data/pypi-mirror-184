...
from pysr3.regularizers import Regularizer, L0RegularizerLME, L1Regularizer, CADRegularizer, SCADRegularizer, \
    DummyRegularizer, PositiveQuadrantRegularizerLME
...
class LMEModel(BaseEstimator, RegressorMixin):
    ...
    The original statistical model_name which this loss is based on is::
    ...
    def fit(self,
        ...
        """
                ...
                fit_fixed_intercept : bool, default = False
                    Whether to add the intercept to the model_name
    ...
    def fit_problem(self,
                    ...
                    **kwargs):
        """
        Fits the model_name to a provided problem
    ...
    def predict(self, x, columns_labels: Optional[List[str]] = None,
        ...
        ----------
        x : np.ndarray
            Data matrix. Should have the same format as the data which was used for fitting the model_name:
    ...
    def predict_problem(self, problem, **kwargs):
        ...
        problem : LMEProblem
            ...
            which was used for fitting the model_name. It may contain new groups, in which case
            the prediction will be formed using the fixed effects only.
    ...
    def score(self, x, y, columns_labels=None, fit_fixed_intercept=False, fit_random_intercept=False,
        ...
        The best possible score is 1.0 and it can be negative (because the model_name can be arbitrarily worse).
        A constant model_name that always predicts the expected value of y,
    ...
    def check_is_fitted(self):
        """
        Checks if the model_name was fitted before. Throws an error otherwise.
        ...
        if not hasattr(self, "coef_") or self.coef_ is None:
            raise NotFittedError("The model_name has not been fitted yet. Call .fit() first.")
...
class SimpleLMEModel(LMEModel):
    ...
    def instantiate(self):
        ...
        regularizer = PositiveQuadrantRegularizerLME(other_regularizer=dummy_regularizer)
...
class SimpleLMEModelSR3(LMEModel):
    ...
    def __init__(self,
        ...
        warm_start_oracle: bool
            if fitting should be started from the current model_name's coefficients.
...
class L0LmeModel(SimpleLMEModel):
    ...
    non-zero fixed and random effects in your model_name
    """
    ...
    def __init__(self,
        ...
        stepping: str
            step-size policy for PGD. Can be either "line-search" or "fixed"
        nnz_tbeta : int
            the maximal number of non-zero fixed effects in your model_name
        nnz_tgamma : int
            the maximal number of non-zero random effects in your model_name
        logger_keys: List[str]
            list of keys for the parameters that the logger should track
        fixed_step_len: float
            step-size for PGD algorithm. If "linear-search" is used for stepping
    ...
    def instantiate(self):
        ...
        l0_regularizer = L0RegularizerLME(nnz_tbeta=self.nnz_tbeta,
                                          ...
                                          oracle=oracle)
        regularizer = PositiveQuadrantRegularizerLME(other_regularizer=l0_regularizer)
        return oracle, regularizer, solver
...
class L1LmeModel(SimpleLMEModel):
    ...
    def instantiate(self):
        ...
        regularizer = PositiveQuadrantRegularizerLME(other_regularizer=l1_regularizer)
        return oracle, regularizer, solver
...
class CADLmeModel(SimpleLMEModel):
    ...
    def instantiate(self):
        ...
        regularizer = PositiveQuadrantRegularizerLME(other_regularizer=cad_regularizer)
        return oracle, regularizer, solver
...
class SCADLmeModel(SimpleLMEModel):
    ...
    def instantiate(self):
        ...
        regularizer = PositiveQuadrantRegularizerLME(other_regularizer=scad_regularizer)
        return oracle, regularizer, solver
