...
class IPN(models.Model):
    ...
    def __repr__(self):
        return f'IPN(client_id="{self.client_id}",client_secret="{self.client_secret}", bank_id="{self.bank_id}", country_code="{self.country_code}", account_number="{self.account_number}", ipn_type={self.ipn_type}, status={self.status})'
