...
def convert_to_tensors(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        ...
        " removed in v1.10.0. Please use `lightning.fabric.utilities.apply_func.convert_to_tensors` instead."
    )
...
def move_data_to_device(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        ...
        " removed in v1.10.0. Please use `lightning.fabric.utilities.apply_func.move_data_to_device` instead."
    )
