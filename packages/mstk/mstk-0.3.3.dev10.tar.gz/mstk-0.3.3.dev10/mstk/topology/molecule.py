...
class Molecule():
    ...
    def split_residues(self):
        '''
        Split the molecule into smaller pieces based on residue.

        Be sure that there is no inter-residue bonds. Otherwise, there will be severe bugs.
        Angles, dihedrals and impropers will be re-generated for better performance.

        TODO Current implementation is fragile
        ...
        for residue in mol.residues:
            ...
            for atom in residue.atoms:
                ...
                for bond in atom.bonds:
                    bonds[bond] = None
            sub._bonds.extend(bonds.keys())
            sub.generate_angle_dihedral_improper()
            pieces.append(sub)
