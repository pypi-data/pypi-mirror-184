import os
from test23.tests.robot.src import ObjMapper
from test23.tests.robot.src.abstract.menu import Menu
from test23.tests.robot.src.manager import RoboManager
...
flag = False
try:
    from test23.tests.testdata.test_data_manager import TestDataManager
    flag = True
except:
