...
from src.test23.tests.pages.locators.softwareites_page_locators import SoftwareitesPageLocators

class SoftwareitesPage(CommonConstants, CustomKeywords, NavBarLocators, SoftwareitesPageLocators): 
