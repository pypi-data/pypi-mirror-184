...
from src.test23.tests.pages.locators.pricingforcypresstestingframeworkcypressiotestingtools_page_locators import PricingforcypresstestingframeworkcypressiotestingtoolsPageLocators

class PricingforcypresstestingframeworkcypressiotestingtoolsPage(CommonConstants, CustomKeywords, NavBarLocators, PricingforcypresstestingframeworkcypressiotestingtoolsPageLocators): 
