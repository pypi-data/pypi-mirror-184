import os
from src.test23.tests.robot.src import ObjMapper
from src.test23.tests.robot.src.abstract.menu import Menu
from src.test23.tests.robot.src import RoboManager
...
flag = False
try:
    from src.test23.tests.testdata import TestDataManager
    flag = True
except:
