...
from src.test23.tests.pages.locators.learnhtmltutorialjavatpoint_page_locators import LearnhtmltutorialjavatpointPageLocators

class LearnhtmltutorialjavatpointPage(CommonConstants, CustomKeywords, NavBarLocators, LearnhtmltutorialjavatpointPageLocators): 
