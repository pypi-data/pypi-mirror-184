...
class RepositoryAccess(ABC):
    ...
    def has_file(self, file_name: str, directory_name: str = "") -> bool:
        for existing_file_name in self.list_files_in_directory(directory_name):
            if existing_file_name["name"] == file_name:
                return True
        return False
