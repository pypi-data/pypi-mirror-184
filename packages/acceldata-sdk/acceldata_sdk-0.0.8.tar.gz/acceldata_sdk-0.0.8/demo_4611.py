...
continuation_id="test_aackward_compat12"
pipeline_run = pipeline.create_pipeline_run(continuation_id=continuation_id, context_data={'key1': 'value2', 'name': 'backend'})
