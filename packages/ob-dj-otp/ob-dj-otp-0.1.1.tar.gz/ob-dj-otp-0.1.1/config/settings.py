...
OTP_FORCE_CODE = None
OTP_RETURN_USAGE = False
OTP_TIMEOUT = 3 * 60
OTP_USER_SERIALIZER = "ob_dj_otp.apis.otp.serializers.UserSerializer"
OTP_AUTH_USAGE_ONLY = False
OTP_EMAIL_AS_PRIMARY_FIELD = False
OTP_PHONE_NUMBER_AS_PRIMARY_FIELD = False

### Custom mixins for serializers
# This variable should contain the serializer name and path to mixin
# Example : {"OTPRequestCodeSerializer": "path.to.mixin_class"}
