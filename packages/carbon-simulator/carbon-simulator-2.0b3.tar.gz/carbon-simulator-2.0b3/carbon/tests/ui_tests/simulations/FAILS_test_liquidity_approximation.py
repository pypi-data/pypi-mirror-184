...
def test_liquidity_approx_order0():
    ...
    assert (
        ...
        == math.sqrt(2000 * 3000) * 10
    )
    assert (
        oui.liquidity_approx(2250, 2750, "USDC", asperc=False)
        == math.sqrt(2250 * 2750) * 0.5 * 10
    )
...
def test_liquidity_approx_order2():
    ...
    assert (oui.pmin, oui.pmax, oui.total_liquidity) == (
        1000.0,
        1500.0,
        (12500.0, "USDC"),
    )
    ...
    assert round(oui.liquidity_approx(1000, 1100, "ETH", asperc=False), 6) == round(
        2500 / math.sqrt(1000 * 1100), 6
    )
    assert round(oui.liquidity_approx(1400, 1500, "ETH", asperc=False), 6) == round(
        2500 / math.sqrt(1400 * 1500), 6
    )
