...
v0.5 add method to average replciates
...
def meanreplicates(dataframe:pd.DataFrame, sepchar:str):
    ...
    after splitting by a defined separated character (sepcahr)
    Input:
    -----
    DataFrame
    ...
    """
    listofsamplebasename = [column.split("_")[0] for column in dataframe.columns]
