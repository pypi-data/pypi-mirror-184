...
from pyutplugins.common.ui.DualSpinnerContainer import DualSpinnerContainer
from pyutplugins.common.ui.DualSpinnerContainer import SpinnerValues
...
class DimensionsContainer(DualSpinnerContainer):
    ...
    def dimensions(self) -> Union[Dimensions, OglDimensions]:
        raise Exception('You can only set the value')
