...
class StandardAPIView(BaseAPIView):
    ...
    def paginate_data(self, data, request, serialized_data=None, serializer_class=None, context=None, **kwargs):
        ...
        if serializer_class:
            serialized_data = serializer_class(paginated_data, many=True, context=context).data
        ...
        response = {
            ...
            'data': serialized_data or paginated_data,
        }
