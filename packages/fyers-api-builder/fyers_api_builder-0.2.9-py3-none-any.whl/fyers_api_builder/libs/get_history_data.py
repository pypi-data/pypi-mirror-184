...
class GetHistoryData:
    ...
    def get_data(self, fetch_from_epoch, fetch_to_epoch):
        payload = generate_payload(
            self.symbol, self.resolution, fetch_from_epoch, fetch_to_epoch
        )
    ...
    def run(self):
        ...
        for task in tasks:
            download_thread = threading.Thread(
                ...
                args=(task["fetch_from_epoch"], task["fetch_to_epoch"]),
            )
