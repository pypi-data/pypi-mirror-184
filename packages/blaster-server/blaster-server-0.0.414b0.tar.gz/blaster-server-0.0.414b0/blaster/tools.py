...
non_alpha_regex_3 = re.compile("[^0-9a-zA-Z_]", re.DOTALL)
blank_spaces_regex = re.compile(r"\s+")
...
def sanitize_to_id2(text):
	text = blank_spaces_regex.sub("_", text.strip().lower())
	return non_alpha_regex_3.sub("", text)
