...
class TensorflowModelMaterializer(ModelMaterializer):
    ...
    def load_ref(self, data_type: Type[Any],
                       ...
                       options: Dict[str, Any] = None) -> Union[tf.Module, GenomeEstimator]:
        ...
        z.extractall(tmpdir)
        tf_model = tf.saved_model.load(tmpdir)
    ...
    def save_to_ref(self, model: Any,
        ...
        tf.saved_model.save(estimator, model_save_path)
