...
class Client:
    ...
    def __environ_of_os(self):
        os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = self.__key_path

        print(f"GOOGLE_APPLICATION_CREDENTIALS = \"{self.__key_path}\" COMPLETE KEY PATH")

    @staticmethod
    def load_file_zip(self, zipfile_name, walking_path, start_path, processing_file_name="csv", files_delimiter=None):
        ...
        def upload_gcs(bucket_name="cw_pm_upload_files", source_file_name=new_zips.filename,
