...
class Instagram:
    ...
    def Login(self):
        ...
        useragent=f'Instagram 266.0.0.0.11 Android (30/11; 320dpi; 720x1449; Xiaomi/POCO; {a2}MI; angelicain; mt6765; en_IN; 435458427)'
        self.Blockversion='0ee04a4a6556c5bb584487d649442209a3ae880ae5c6380b16235b870fcc4052'
        headers = {
        ...
        data = {
            'signed_body': 'SIGNATURE.{"jazoest":"'+str(generate_jazoest(str(IgFamilyDeviceId)))+'","country_codes":"[{\\"country_code\\":\\"1\\",\\"source\\":[\\"default\\"]},{\\"country_code\\":\\"91\\",\\"source\\":[\\"sim\\"]}]","phone_id":"'+str(IgFamilyDeviceId)+'","enc_password":"#PWD_INSTAGRAM:0:'+str(round(time.time()))+':'+str(self.passw)+'","username":"'+str(self.user)+'","adid":"'+str(uuid.uuid4())+'","guid":"'+str(IgDeviceId)+'","device_id":"'+str(AndroidID)+'","google_tokens":"[]","login_attempt_count":"0"}',
        }
