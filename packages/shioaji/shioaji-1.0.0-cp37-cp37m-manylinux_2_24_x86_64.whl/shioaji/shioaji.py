...
class Quote:
    ...
    def subscribe(
        ...
        version: QuoteVersion = QuoteVersion.v0,
    ):
        pass
...
class Shioaji:
    ...
    def login(
        ...
        if fetch_contract:
            self.fetch_contracts(
                contract_download, contracts_timeout, contracts_cb
            )
    ...
    def place_comboorder(
        ...
        if order.account:
            if order.account.account_type == AccountType.Future:
                return self._solace.place_comboorder(
    ...
    def reserve_stock(
        ...
        if account.signed:
            resp = self._solace.reserve_stock(
                account, contract, share, timeout, cb
            )
            return resp
        else:
            raise AccountNotSignError(account)
    ...
    def list_position_detail(
        ...
        cb: typing.Callable[
            [
                typing.List[
                    typing.Union[StockPositionDetail, FuturePositionDetail]
                ]
            ],
            None,
        ] = None,
    ...
    def list_profit_loss_summary(
        ...
        cb: typing.Callable[
            [
                typing.List[
                    typing.Union[
                        StockProfitLossSummary, FutureProfitLossSummary
                    ]
                ]
            ],
            None,
