...
class Cakework(cakework_pb2_grpc.CakeworkServicer):
    ...
    def background(self, user_id, app, request_id, parameters):
        ...
        try:
            ...
            print("got an error: ") # Q: do we want to expose this to customers? note: anything we put here will be printed to customer. 
            print(e)
            # print(e)
