...
#         self.indexes = indexes
        ...
        if drop_unmatched == True:
            ...
            self.matched_ids = self.matched_ids.dropna().reset_index(drop=True)

            ids_minor_cleaned = self.matched_ids[self.indx].astype(
                int).tolist()
            minor_pred_rstindx = minor_pred_rstindx.take(ids_minor_cleaned)
