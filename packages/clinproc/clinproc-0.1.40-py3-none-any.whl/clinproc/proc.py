...
from clinproc.utils import *
from clinproc.regex_patterns import *
from clinproc.ctconfig import CTConfig
from clinproc.ctdocument import CTDocument
from clinproc.move_negation import move_neg, move_negs
...
if __name__ == "__main__":
    ...
    ct_config = CTConfig(data)
    docs = [doc for doc in ClinProc.process_data(ct_config)]
    print(docs[0])
