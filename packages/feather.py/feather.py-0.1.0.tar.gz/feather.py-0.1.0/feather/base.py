...
from feather._misc import process_commands
from feather.sqlite import connect, run_sql

parser = argparse.ArgumentParser("feather", usage="feather *[options]", description="SQLITE3 in CLI.", add_help=True)
