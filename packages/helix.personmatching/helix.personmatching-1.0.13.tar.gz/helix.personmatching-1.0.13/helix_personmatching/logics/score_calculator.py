...
from nicknames import NickNamer, default_lookup, _lookup_from_csv
...
class ScoreCalculator:
    ...
    def calculate_score(
        ...
        if ScoreCalculator.nick_namer is None:
            nickname_lookup: Dict[str, Set[str]] = ScoreCalculator.load_nick_names()
    ...
    def load_nick_names() -> Dict[str, Set[str]]:
        ...
        path = Path(data_dir.joinpath("nick_name_overrides.csv"))
        nickname_overrides: Dict[str, Set[str]] = _lookup_from_csv(path)
