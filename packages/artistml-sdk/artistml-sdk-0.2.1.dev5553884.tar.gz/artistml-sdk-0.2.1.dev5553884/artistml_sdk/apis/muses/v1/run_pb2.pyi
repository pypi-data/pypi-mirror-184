...
class Run(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["create_at",b"create_at","flow_id",b"flow_id","id",b"id","name",b"name","run_detail",b"run_detail","runtime_config",b"runtime_config","trigger",b"trigger","update_at",b"update_at"]) -> None: ...
global___Run = Run
