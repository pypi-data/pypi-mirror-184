...
from typing import Any, List, Dict, Iterable, Optional, Literal
import re
...
def fetch_table(data: LegacyCursorResult | Iterable, fields: Optional[Iterable] = None) -> list[dict,]:
        """
...
def fetch_df(data: LegacyCursorResult | Iterable, fields: Optional[Iterable] = None) -> DataFrame:
        """
...
def fetch_sql(data: LegacyCursorResult | Iterable, fields: Optional[Iterable] = None) -> str:
    """
...
class RConn(object):
    ...
    def create_conn(
        ...
        port: str | int = get_first_notnull(port, self.port, default="error")
    ...
    def execute_select(
            ...
            limit: Optional[int | str | Iterable[int | str]] = None,
