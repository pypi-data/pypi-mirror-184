...
.. |commits-since| image:: https://img.shields.io/github/commits-since/hamid-vakilzadeh/pyglassdoor/v0.1.0.svg
    :alt: Commits since latest release
    :target: https://github.com/hamid-vakilzadeh/pyglassdoor/compare/v0.1.0...master
...
.. code:: python
    ...
    query = gd.get_reviews(company_id=1138, max_reviews=20)
