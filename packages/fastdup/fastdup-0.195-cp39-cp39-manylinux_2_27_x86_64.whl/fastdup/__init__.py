...
def do_run(input_dir='',
    ...
    if isinstance(input_dir, list):
        ...
        files_path = os.path.join(work_dir, 'files.txt')
    ...
    if isinstance(test_dir, list):
        ...
        files.to_csv(os.path.join(work_dir, INPUT_TEST_FILE_LOCATION))
        test_dir = os.path.join(work_dir, INPUT_TEST_FILE_LOCATION)
