def product_description(competency, names):
    ...
    if competency == "get_transactions":
        ...
        # account type is refering to fees, rates, etc bcuz i didnt know what else to name it
    ...
    return [
        {
            ...
            "cases": {"subtype": "faq_describe_accounts", "type_of_account": product},
        },
        {
            "competency": "faq_describe_accounts",
            "cases": {"subtype": "faq_product_rates", "type_of_account": product},
        },
        {
            "competency": "faq_describe_accounts",
            "cases": {"subtype": "faq_product_fees", "type_of_account": product},
        },
        {"competency": "faq_open_account", "cases": {"type_of_account": product}},
        {"competency": "get_transactions", "cases": {"trxn_spnd_hist_filter": product}},
    ]
