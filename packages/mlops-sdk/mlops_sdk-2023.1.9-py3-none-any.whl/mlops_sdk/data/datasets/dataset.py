...
from mlops_sdk.mlops_client import MlopsClient, MlopsError
from mlops_sdk.data.datasets.models import Dataset, DatasetPutIn, DatasetPatchIn
from mlops_sdk.data.datasets.models.params import PARAMS, PARAMS_PATCH


loop = asyncio.get_event_loop()


class DatasetClient(MlopsClient):
    """
    Client for Mlops Data API (`/v1/datasets/`).
    ...
    async def list_datasets_async(self) -> List[Dataset]:
        ...
        ## Returns
        list(`mlops.data.datasets.Dataset`)
