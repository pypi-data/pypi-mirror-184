...
from mlops_sdk.rec.experiments.models import Experiment, ExperimentPutIn, ExperimentPatchIn

loop = asyncio.get_event_loop()


class ExperimentClient(MlopsClient):
    """
    Client for Mlops Recommendation API (`/v1/experiments/`).
    ...
    client = mlops.client("experiment")
    ```
    """
    ...
    async def create_experiment_async(
        ...
        ## Returns
        `mlops.rec.experiments.models.Experiment`
    ...
    async def list_experiments_async(self) -> List[Experiment]:
        ...
        ## Returns
        list(`mlops.rec.experiments.models.Experiment`)
