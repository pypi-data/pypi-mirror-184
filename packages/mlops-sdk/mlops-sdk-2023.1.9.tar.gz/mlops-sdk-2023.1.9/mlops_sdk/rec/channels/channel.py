...
from mlops_sdk.rec.channels.models import Channel, ChannelPutIn, ChannelPatchIn

loop = asyncio.get_event_loop()


class ChannelClient(MlopsClient):
    """
    Client for Mlops Recommendation API (`/v1/channels/`).
    ...
    async def create_channel_async(self, id: str, experiment_id: str = None) -> Channel:
        ...
        ## Returns
        `mlops.rec.channels.models.Channel`
    ...
    async def list_channels_async(self) -> List[Channel]:
        ...
        ## Returns
        list(`mlops.rec.channels.models.Channel`)
