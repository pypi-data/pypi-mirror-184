...
import json
from ibm_watson_machine_learning.utils import get_url, print_text_header_h2, print_text_header_h1, StatusLogger
...
class LearningSystem(WMLResource):
    ...
    def setup(self, model_uid, meta_props):
        ...
        **Example**
        ...
        """
        self._validate_type(model_uid, u'model_uid', str, True)
    ...
    def list(self):
        """Print existing learning systems in a table format.
    ...
    def run(self, model_uid, asynchronous=True):
        ...
        :param asynchronous: if the run should be asynchronous
    ...
    def get_run_href(self, run_details):
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            client.learning_system.get_run_href(run_details)
        """
        self._validate_type(run_details, u'run_details', dict, True)
    ...
    def list_runs(self, model_uid=None):
        """Print learning iterations in a table format.
        ...
        **Example**
        ...
        """
        self._validate_type(model_uid, u'model_uid', str, False)
    ...
    def get_run_details(self, run_uid):
        ...
        **Example**
        ...
        """
        self._validate_type(run_uid, u'run_uid', str, True)
