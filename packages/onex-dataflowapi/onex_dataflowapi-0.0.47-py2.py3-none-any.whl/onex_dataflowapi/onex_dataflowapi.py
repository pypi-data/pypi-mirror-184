...
class DataflowFlowProfile(OpenApiObject):
    ...
    def __init__(self, parent=None, choice=None, name=None, data_size=None, mtu=1500):
...
class DataflowFlowProfileRdmaStackRoceV2(OpenApiObject):
    ...
    def __init__(self, parent=None, verb='write', bidirectional=False, iterations=1):
...
class DataflowFlowProfileIter(OpenApiIter):
    ...
    def flowprofile(self, name=None, data_size=None, mtu=1500):
        # type: (str,int,int) -> DataflowFlowProfileIter
        ...
        Returns: DataflowFlowProfileIter
        """
        item = DataflowFlowProfile(parent=self._parent, choice=self._choice, name=name, data_size=data_size, mtu=mtu)
        self._add(item)
        return self

    def add(self, name=None, data_size=None, mtu=1500):
        # type: (str,int,int) -> DataflowFlowProfile
