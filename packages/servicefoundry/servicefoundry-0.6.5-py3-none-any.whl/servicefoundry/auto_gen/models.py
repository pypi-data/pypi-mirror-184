...
#   timestamp: 2022-12-29T12:34:15+00:00
...
class ConfigMapItem(BaseModel):
    ...
    data: Dict[str, str] = Field(..., description="+usage=Data to be mounted")
...
class Param(BaseModel):
    name: constr(regex=r"^[a-z][a-z0-9-_]{1,31}$") = Field(
        ..., description="+usage=Name of the param"
    )
    description: Optional[constr(regex=r"^.{1,127}$")] = Field(
        None, description="+usage=Description of param"
    )
    default: Optional[constr(regex=r"^.{1,127}$")] = Field(
        None, description="+usage=Default value or placeholder"
    )
...
class Port(BaseModel):
    ...
    ] = Field(None, description="+usage=Host")
    path: Optional[
        constr(regex=r"^(/([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9\-]*[a-zA-Z0-9]))*/$")
    ] = Field(None, description="+usage=Path")
...
class ConfigMapItem1(BaseModel):
    mount_path: str = Field(
        ..., description="+usage=Path at which data is to be mounted"
    )
    data: Dict[str, str] = Field(..., description="+usage=Data to be mounted")
...
class Job(BaseModel):
    ...
    restart: Restart = Field("Never", description="+usage=When to restart the job")
    command: Optional[Union[str, List[str]]] = Field(
        None,
    ...
    config_map: Optional[List[ConfigMapItem]] = Field(
        None, description="+usage=Config Maps\n+ignore"
    )
...
class Notebook(BaseModel):
    """
    +docs=Describes the configuration for the notebook
    """
...
class Service(BaseModel):
    ...
    config_map: Optional[List[ConfigMapItem1]] = Field(
        None, description="+usage=Config Maps\n+ignore"
    )
