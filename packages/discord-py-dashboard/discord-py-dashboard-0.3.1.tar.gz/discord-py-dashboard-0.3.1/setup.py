...
version = ""
with open("discord/py/dashboard/__init__.py") as f:
...
setup(name='discord-py-dashboard',
      author='MaseZev',
      url='https://github.com/MaseZev/discord-py-dashboard',
      version=version,
      packages=['discord.py.dashboard'],
      license='mit',
