...
def load(
    ...
    """Loads in a file and returns the parsed data

    Args:
        path (str): Absolute or relative path to the file to be parsed.
...
def dumps(data: List[List] | List[Dict], headers: List[str] = None, padding: str = ' ', cell_suffix: str = ' ') -> str:
...
def dump(data: List[List] | List[Dict], file_object: io.TextIOWrapper, headers: List[str] = None, padding: str = ' ', cell_suffix: str = ' '):
