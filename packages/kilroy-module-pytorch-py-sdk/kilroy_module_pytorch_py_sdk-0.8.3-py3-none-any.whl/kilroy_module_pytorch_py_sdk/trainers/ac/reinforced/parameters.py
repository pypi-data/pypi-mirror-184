...
from kilroy_module_pytorch_py_sdk.trainers.ac.reinforced.cache import Cache
...
class MethodParameter(CategorizableBasedParameter[State, Method]):
    ...
    def default_categorizable(cls) -> Type[Method]:
        return BootstrappingEarlyStoppingPolicyOptimizationMethod
...
class CacheParameter(NestedParameter[State, Cache]):
    pass
