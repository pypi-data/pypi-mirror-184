...
class TextgridCrudRequest:
    ...
    def read_data(self, textgrid_uri: str, sid: Optional[str] = '') -> Response:
        """Read Data
        ...
        response = requests.get(self._url + '/' + textgrid_uri +
                                '/data?sessionId=' + sid,
                                stream=True,
                                timeout=self._config.http_timeout)
        return self._handle_response(response)

    def read_metadata(self, textgrid_uri: str, sid: Optional[str] = '') -> Response:
        """Read Metadata
...
class TextgridCrud(TextgridCrudRequest):
    ...
    def read_metadata(self, textgrid_uri: str, sid: Optional[str] = '') -> MetadataContainerType:
        """Read Metadata
