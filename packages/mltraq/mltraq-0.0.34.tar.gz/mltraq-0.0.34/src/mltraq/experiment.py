...
class Experiment:
    ...
    def __init__(
        ...
        Args:
            ...
            steps (Union[Callable, List[Callable]], optional): One or more functions to call. Defaults to None.
    ...
    def run(self):
        try:
            ...
            self.runs.add(run)  # [str(run.id_run)] = run

    def _repr_html_(self):
        return f'add_experiment(name="{self.name}", n_runs={len(self.runs)}, id="{self.id_experiment}")'
