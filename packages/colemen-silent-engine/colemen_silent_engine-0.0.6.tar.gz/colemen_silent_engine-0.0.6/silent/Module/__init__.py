...
class Module(_eb.EntityBase):
    ...
    def __init__(self,main:config._main_type,package:config._package_type,**kwargs) -> None:
        '''
    ...
    def add_class(self,name:str,description:str=None,is_dataclass:bool=False,bases:Union[str,list]=None)->config._py_class_type:
        '''
            ...
            [`bases`=None] {str,list}
                A base class or list of classes that this class will extend.
    ...
    # @property
    # def _class_declarations(self):
    #     '''
    #         Get the _classes property's value
    ...
    #         ----------
    #         `@author`: Colemen Atwood
    #         `@created`: 01-04-2023 10:48:15
    #         `@memberOf`: __init__
    #         `@property`: _classes
    #     '''
    #     value = []
    #     for mclass in self.classes:
    #         value.append(mclass.result)
    #     value= '\n\n\n'.join(value)
    #     return value
    ...
    def add_method(self,name,**kwargs)->config._method_type:
        '''
        ...
        method = _method.Method(
            ...
            body=c.obj.get_kwarg(['body'],None,(str),**kwargs),
            return_type=c.obj.get_kwarg(['return_type'],None,(str),**kwargs),
            return_description=c.obj.get_kwarg(['return_description'],None,(str),**kwargs),
            is_getter=False,
            is_setter=False,
