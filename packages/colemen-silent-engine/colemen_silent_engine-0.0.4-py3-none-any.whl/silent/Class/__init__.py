...
class Class(_eb.EntityBase):
    ...
    def __init__(self,main:config._master_type,module:config._py_module_type,**kwargs) -> None:
        '''
        ...
        # self.main:config._master_type = main
    ...
    def add_property(self,name:str,**kwargs)->config._py_property_type:
        '''
    ...
    def add_method(self,name,**kwargs)->config._method_type:
        ...
        method = _method.Method(
            ...
            is_getter=c.obj.get_kwarg(['is_getter'],False,(bool),**kwargs),
            is_setter=c.obj.get_kwarg(['is_setter'],False,(bool),**kwargs),
    ...
    def add_getter(self,name,**kwargs)->config._method_type:
        '''
    ...
    def add_setter(self,name,**kwargs)->config._method_type:
        '''
