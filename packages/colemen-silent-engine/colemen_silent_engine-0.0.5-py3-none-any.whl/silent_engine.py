...
class Main:
    ...
    def add_package(self,name:str,description:str=None,**kwargs)->config._package_type:
        '''
        ...
        pkg = _package.Package(
            ...
            file_path=file_path,
            overwrite=c.obj.get_kwarg(['overwrite'],True,(bool),**kwargs),
        )
        # self._entities['packages'].append(pkg)
        # self._packages[name] = pkg
        return pkg

    def get_package(self,name)->config._package_type:
        '''
        ...
        for pkg in self.packages:
            ...
            if pkg.import_path == name:
                return pkg
        # if name in self._entities['packages']:
            # return self._entities['packages'][name]
