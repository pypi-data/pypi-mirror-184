...
class TkSES():
    ...
    def send_html_email(self, email_message):
        try:
            ...
            response = self.client.send_email(
                ...
                Message={'Subject': {'Data': email_message.subject}, 'Body': {'Html': {'Data': str(email_message.message)}}}
            )
            return response
    ...
    def send_raw_email(self, email_message):
        try:
            self.get_client()
            destination = {'ToAddresses': email_message.to_emails, 'CcAddresses': email_message.cc_emails, 'BccAddresses': email_message.bcc_emails}
            response = self.client.send_email(
                Source=email_message.from_email,
                Destination=destination,
                Message={'Subject': {'Data': email_message.subject}, 'Body': {'Html': {'Data': email_message.message}}}
            )
            # response = self.client.send_raw_email(
            #     Source= email_message.sender_email,
            #     Destinations=email_message.to_emails + email_message.cc_emails,
            #     RawMessage={
