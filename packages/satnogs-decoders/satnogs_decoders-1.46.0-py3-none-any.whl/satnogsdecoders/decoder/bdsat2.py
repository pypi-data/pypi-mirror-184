...
class Bdsat2(KaitaiStruct):
    ...
    :field bds_state: ax25_frame.payload.ax25_info.body.bds_hwstate
    ...
    :field bds_tmp_ei_0: ax25_frame.payload.ax25_info.body.bds_tmp_ei_0
    :field bds_tmp_ei_1: ax25_frame.payload.ax25_info.body.bds_tmp_ei_1
    :field bds_pres_ei_0: ax25_frame.payload.ax25_info.body.bds_pres_ei_0
    """
    ...
    class Callsign(KaitaiStruct):
        ...
        def _read(self):
            ...
            if not  ((self.callsign == u"OK0BDT") or (self.callsign == u"CQ    ")) :
    ...
    class Bds(KaitaiStruct):
        ...
        def bds_tmp_e2_1(self):
            if hasattr(self, '_m_bds_tmp_e2_1'):
                return self._m_bds_tmp_e2_1 if hasattr(self, '_m_bds_tmp_e2_1') else None
        ...
        def bds_tmp_c1(self):
            if hasattr(self, '_m_bds_tmp_c1'):
                return self._m_bds_tmp_c1 if hasattr(self, '_m_bds_tmp_c1') else None
        ...
        def bds_tmp_e1_3(self):
            if hasattr(self, '_m_bds_tmp_e1_3'):
                return self._m_bds_tmp_e1_3 if hasattr(self, '_m_bds_tmp_e1_3') else None
        ...
        def bds_tmp_e2_0(self):
            if hasattr(self, '_m_bds_tmp_e2_0'):
                return self._m_bds_tmp_e2_0 if hasattr(self, '_m_bds_tmp_e2_0') else None
        ...
        def bds_tmp_c0(self):
            if hasattr(self, '_m_bds_tmp_c0'):
                return self._m_bds_tmp_c0 if hasattr(self, '_m_bds_tmp_c0') else None
        ...
        def bds_tmp_e1_0(self):
            if hasattr(self, '_m_bds_tmp_e1_0'):
                return self._m_bds_tmp_e1_0 if hasattr(self, '_m_bds_tmp_e1_0') else None
        ...
        def bds_tmp_e1_2(self):
            if hasattr(self, '_m_bds_tmp_e1_2'):
                return self._m_bds_tmp_e1_2 if hasattr(self, '_m_bds_tmp_e1_2') else None
        ...
        def bds_tmp_ei_0_float(self):
            if hasattr(self, '_m_bds_tmp_ei_0_float'):
                return self._m_bds_tmp_ei_0_float if hasattr(self, '_m_bds_tmp_ei_0_float') else None
        ...
        def bds_tmp_ei_1_float(self):
            if hasattr(self, '_m_bds_tmp_ei_1_float'):
                return self._m_bds_tmp_ei_1_float if hasattr(self, '_m_bds_tmp_ei_1_float') else None
        ...
        def bds_pres_ei_1_float(self):
            if hasattr(self, '_m_bds_pres_ei_1_float'):
                return self._m_bds_pres_ei_1_float if hasattr(self, '_m_bds_pres_ei_1_float') else None
        ...
        def bds_tmp_e2_3(self):
            if hasattr(self, '_m_bds_tmp_e2_3'):
                return self._m_bds_tmp_e2_3 if hasattr(self, '_m_bds_tmp_e2_3') else None
        ...
        def bds_tmp_e2_2(self):
            if hasattr(self, '_m_bds_tmp_e2_2'):
                return self._m_bds_tmp_e2_2 if hasattr(self, '_m_bds_tmp_e2_2') else None
        ...
        def bds_pres_ei_0_float(self):
            if hasattr(self, '_m_bds_pres_ei_0_float'):
                return self._m_bds_pres_ei_0_float if hasattr(self, '_m_bds_pres_ei_0_float') else None
        ...
        def bds_tmp_e1_1(self):
            if hasattr(self, '_m_bds_tmp_e1_1'):
                return self._m_bds_tmp_e1_1 if hasattr(self, '_m_bds_tmp_e1_1') else None
