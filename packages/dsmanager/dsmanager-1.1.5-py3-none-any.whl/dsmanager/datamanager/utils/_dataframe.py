            ...
            .assign(
                **{
                    "trim_mean_01": stats.trim_mean(
                        df_.assign(**{cat: np.nan for cat in cat_cols}), 0.1
                    ),
                    "skew": stats.skew(df_.assign(**{cat: np.nan for cat in cat_cols})),
                    "kurtosis": stats.kurtosis(
                        df_.assign(**{cat: np.nan for cat in cat_cols})
                    ),
                    "sem": stats.sem(df_.assign(**{cat: np.nan for cat in cat_cols})),
