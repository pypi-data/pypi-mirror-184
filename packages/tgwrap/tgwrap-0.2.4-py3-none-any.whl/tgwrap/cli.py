...
@click.option(
    '--project', '-p', default="",
    help='Name of the project, if omitted all projects will be copied.',
    )
...
@click.version_option(version=__version__)
def deploy(source_domain, source_stage, target_domain, target_stage, project, verbose, dry_run, clean_up, include_lock_file, working_dir):
