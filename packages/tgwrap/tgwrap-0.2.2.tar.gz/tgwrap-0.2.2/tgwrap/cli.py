...
warn_if_outdated(PACKAGE_NAME, __version__)
...
@click.version_option(version=__version__)
def deploy(source_domain, source_stage, target_domain, target_stage, verbose, dry_run, clean_up, include_lock_file, working_dir):
