...
def add(add1, add2):
    dimention1 = checkDimention(add1)
    dimention2 = checkDimention(add2)
    if dimention1 == 1 and dimention2 == 1:
        return addFor1d(add1, add2)
    elif dimention1 == 2 and dimention2 == 2:
        return addFor2d(add1, add2)
    else:
        return 'must be 1 or 2 dimention listand both lists must be same dimention'
...
def sub(add1, add2):
    ...
    dimention2 = checkDimention(add2)
    if dimention1 == 1 and dimention2 == 1:
        return subFor1d(add1, add2)
    elif dimention1 == 2 and dimention2 == 2:
        return subFor2d(add1, add2)
    else:
        return 'must be 1 or 2 dimention listand both lists must be same dimention'
