...
# Get azure-maps-jupyter version
...
jstargets = [
    os.path.join('azure-maps-jupyter/nbextension', 'index.js'),
    os.path.join('azure-maps-jupyter/labextension', 'package.json'),
]

data_files_spec = [
    ('share/jupyter/nbextensions/jupyter-leaflet', 'azure-maps-jupyter/nbextension', '*.*'),
    ('share/jupyter/labextensions/jupyter-leaflet', 'azure-maps-jupyter/labextension', "**"),
