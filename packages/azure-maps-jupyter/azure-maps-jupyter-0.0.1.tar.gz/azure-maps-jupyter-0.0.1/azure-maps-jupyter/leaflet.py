...
def basemap_to_tiles(basemap, day=yesterday, **kwargs):
    ...
    basemap : class:`xyzservices.lib.TileProvider` or Dict
        Basemap description coming from azure-maps-jupyter.basemaps.
    day: string
...
class Layer(Widget, InteractMixin):
    ...
    Base class for all layers in azure-maps-jupyter.
...
class WMSLayer(TileLayer):
    ...
    crs: dict, default azure-maps-jupyter.projections.EPSG3857
...
class Control(Widget):
    ...
    This is the base class for all azure-maps-jupyter controls. A control is additional
...
class AttributionControl(Control):
    ...
    prefix = Unicode('azure-maps-jupyter').tag(sync=True, o=True)
...
class LegendControl(Control):
    ...
    def __init__(self, legend, *args, **kwargs):
        ...
        # For backwards compatibility with azure-maps-jupyter<=0.16.0
        if 'name' in kwargs:
...
class Map(DOMWidget, InteractMixin):
    ...
    The Map class is the main widget in azure-maps-jupyter.
