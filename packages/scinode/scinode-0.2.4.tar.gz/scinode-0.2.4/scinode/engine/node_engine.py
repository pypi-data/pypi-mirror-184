...
class EngineNode(DBItem):
    ...
    def process(self, pool, future=None):
        ...
        """
        try:
            future = self.apply_action(pool, future)
        except Exception:
            import traceback
    ...
    def apply_action(self, pool, future=None):
        dbdata = self.record
    ...
    def gather(self):
        ...
        print("  Node: {} is gathered: {}".format(dbdata["name"], results))
        self.state = "FINISHED"
        self.action = "NONE"
