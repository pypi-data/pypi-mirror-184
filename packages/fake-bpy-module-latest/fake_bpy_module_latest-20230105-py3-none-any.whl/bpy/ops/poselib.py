...
def apply_pose_asset(override_context: typing.
    ...
    :type undo: bool
    :param blend_factor: Blend Factor, Amount that the pose is applied on top of the existing poses. A negative value will apply the pose flipped over the X-axis
    :type blend_factor: float
    :param flipped: Apply Flipped, When enabled, applies the pose flipped over the X-axis. This is the same as passing a negative `blend_factor`
    :type flipped: bool
    '''
