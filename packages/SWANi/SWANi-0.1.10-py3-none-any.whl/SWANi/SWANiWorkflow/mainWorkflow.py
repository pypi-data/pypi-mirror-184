...
from SWANi.SWANiWorkflow.SWANiLib import (Workflow_mo, create_probtrackx2_pipeline, Dcm2niix_mo,Orient_mo,
                                  SwapDimensions,segmentHA_mo,Label2Vol_mo,thrROI, AIndex, Zscore,
                                  VenosaCheck, BEDPOSTX5_mo, getn, DilateImage_mo)
...
class SWANi_wf(Workflow_mo):
    ...
    def add_input_folders(self,SWANiGlobalConfig,check_input,isfreesurfer):
        ...
        max_cpu= max(int((cpu_count()-2)/2),1)

        #ELABORAZIONE T1 3D
        #coversione dicom->nifti
        ref_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_mr_t13d_folder'])
        ...
        if isfreesurfer: 
            ...
            reconAll.inputs.subjects_dir=abspath(os.getcwd())
            reconAll.inputs.subject_id="FS"
            reconAll.inputs.openmp=max_cpu
        ...
        if check_input['mr_flair3d']:
            ...
            flair_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_mr_flair3d_folder'])
        ...
        if wfType==1 and check_input['mr_flair3d']and DOmap:
            ...
            DOmap_cortexMask.inputs.mask_file=SWANi_supplement.cortex_mas
        ...
        if flair2D and check_input['op_mr_flair2d_tra']:
            ...
            flair_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_op_mr_flair2d_tra_folder'])
        ...
        if flair2D and check_input['op_mr_flair2d_cor']:
            ...
            flair_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_op_mr_flair2d_cor_folder'])
        ...
        if flair2D and check_input['op_mr_flair2d_sag']:
            ...
            flair_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_op_mr_flair2d_sag_folder'])
        ...
        if check_input['mr_mdc']:
            ...
            mdc_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_mr_mdc_folder'])
        ...
        if check_input['mr_asl']:
            ...
            asl_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_mr_asl_folder'])
        ...
        if check_input['pet_brain'] and check_input['ct_brain']:
            ...
            pet_ct_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_ct_brain_folder'])
            ...
            pet_brain_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_pet_brain_folder'])
        ...
        if wfType==0 and check_input['mr_venosa']:
            ...
            venosa_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_mr_venosa_folder'])
            ...
            if check_input['mr_venosa2']:
                ...
                venosa2_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_mr_venosa2_folder'])
        ...
        if check_input['mr_dti']:    
            ...
            dti_dir = abspath(SWANiGlobalConfig['DEFAULTFOLDERS']['default_mr_dti_folder'])
        ...
        t1.sink_result(abspath("."),ref_BET,'out_file','scene')
        t1.sink_result(abspath("."),ref_reOrient,'out_file','scene')
        ...
        if isfreesurfer:           
            ...
            freesurfer.sink_result(abspath("."),aparaseg2Volmgz,'vol_label_file','scene')
            freesurfer.sink_result(abspath("."),reconAll,'pial','scene')
            freesurfer.sink_result(abspath("."),reconAll,'white','scene')
            if wfType==1 and isHippoAmygLabels:
                ...
                freesurfer.sink_result(abspath("."),segmentHA,'lh_hippoAmygLabels','scene.segmentHA',regex_subs)
                freesurfer.sink_result(abspath("."),segmentHA,'rh_hippoAmygLabels','scene.segmentHA',regex_subs)
        ...
        if check_input['mr_flair3d']:
            ...
            flair.sink_result(abspath("."),flair2ref_FLIRT,'out_file','scene')
        ...
        if flair2D and check_input['op_mr_flair2d_tra']:
            ...
            flair2d_tra.sink_result(abspath("."),flair2d_tra2ref_FLIRT,'out_file','scene')
        ...
        if flair2D and check_input['op_mr_flair2d_cor']:
            ...
            flair2d_cor.sink_result(abspath("."),flair2d_cor2ref_FLIRT,'out_file','scene')
        ...
        if flair2D and check_input['op_mr_flair2d_sag']:
            ...
            flair2d_sag.sink_result(abspath("."),flair2d_sag2ref_FLIRT,'out_file','scene')
        ...
        if check_input['mr_mdc']:
            ...
            mdc.sink_result(abspath("."),mdc2ref_FLIRT,'out_file','scene')
        ...
        if check_input['mr_asl']:
            ...
            asl.sink_result(abspath("."),asl_mask,'out_file','scene')
            if wfType==1:
                ...
                asl.sink_result(abspath("."),asl_AI2ref,'out_file','scene')                                  
            if isfreesurfer:
                ...
                asl.sink_result(abspath("."),asl_surf_lh,'out_file','scene')
                asl.sink_result(abspath("."),asl_surf_rh,'out_file','scene')      
                if wfType==1:
                    ...
                    asl.sink_result(abspath("."),aslAI_surf_lh,'out_file','scene')
                    asl.sink_result(abspath("."),aslAI_surf_rh,'out_file','scene')                    
                    ...
                    asl.sink_result(abspath("."),asl_zscore_mask,'out_file','scene')
                    ...
                    asl.sink_result(abspath("."),aslZscore_surf_lh,'out_file','scene')
                    asl.sink_result(abspath("."),aslZscore_surf_rh,'out_file','scene')  
        ...
        if check_input['pet_brain'] and check_input['ct_brain']:           
            ...
            pet.sink_result(abspath("."),pet_brain_SMOOTH,'out_file','scene')
            if wfType==1:
                ...
                pet.sink_result(abspath("."),pet_AI_mask,'out_file','scene')                      
            if isfreesurfer:
                ...
                pet.sink_result(abspath("."),pet_surf_lh,'out_file','scene')
                pet.sink_result(abspath("."),pet_surf_rh,'out_file','scene')
                if wfType==1:
                    ...
                    pet.sink_result(abspath("."),petAI_surf_lh,'out_file','scene')
                    pet.sink_result(abspath("."),petAI_surf_rh,'out_file','scene') 
                    ...
                    pet.sink_result(abspath("."),pet_zscore_mask,'out_file','scene')
                    ...
                    pet.sink_result(abspath("."),petZscore_surf_lh,'out_file','scene')
                    pet.sink_result(abspath("."),petZscore_surf_rh,'out_file','scene')  
        ...
        if wfType==0 and check_input['mr_venosa']:
            ...
            venosa.sink_result(abspath("."),venosa2ref_FLIRT,'out_file','scene') 
        ...
        if check_input['mr_dti']:
            ...
            dti_preproc.sink_result(abspath("."),FA2ref_FLIRT,'out_file','scene')            
            if wfType==0:
                ...
                for tract in SWANiGlobalConfig['DEFAULTTRACTS'].keys():
                    ...
                    tractWf_list[tract]=create_probtrackx2_pipeline('tract_'+tract,tract,abspath("."))
