...
['packages',
 'packages.akit',
 'packages.akit.activation',
 'packages.akit.cli',
 'packages.akit.cli.cmdtree',
 'packages.akit.cli.cmdtree.databases',
 'packages.akit.cli.cmdtree.generators',
 'packages.akit.cli.cmdtree.network',
 'packages.akit.cli.cmdtree.servers',
 'packages.akit.cli.cmdtree.testing',
 'packages.akit.coupling',
 'packages.akit.cryptography',
 'packages.akit.datum',
 'packages.akit.environment',
 'packages.akit.interfaces',
 'packages.akit.interop',
 'packages.akit.interop.agents',
 'packages.akit.interop.clients',
 'packages.akit.interop.cluster',
 'packages.akit.interop.concurrency',
 'packages.akit.interop.coordinators',
 'packages.akit.interop.credentials',
 'packages.akit.interop.dns',
 'packages.akit.interop.eventsinking',
 'packages.akit.interop.landscaping',
 'packages.akit.interop.landscaping.layers',
 'packages.akit.interop.serial',
 'packages.akit.interop.upnp',
 'packages.akit.interop.upnp.content',
 'packages.akit.interop.upnp.devices',
 'packages.akit.interop.upnp.extensions',
 'packages.akit.interop.upnp.extensions.dynamic',
 'packages.akit.interop.upnp.extensions.dynamic.embeddeddevices',
 'packages.akit.interop.upnp.extensions.dynamic.rootdevices',
 'packages.akit.interop.upnp.extensions.dynamic.services',
 'packages.akit.interop.upnp.extensions.dynamic.services.MicrosoftCorporation',
 'packages.akit.interop.upnp.extensions.dynamic.services.NETGEAR',
 'packages.akit.interop.upnp.extensions.dynamic.services.NETGEARInc',
 'packages.akit.interop.upnp.extensions.dynamic.services.SonosInc',
 'packages.akit.interop.upnp.extensions.standard.embeddeddevices',
 'packages.akit.interop.upnp.extensions.standard.rootdevices',
 'packages.akit.interop.upnp.extensions.standard.rootdevices.sonos',
 'packages.akit.interop.upnp.extensions.standard.services',
 'packages.akit.interop.upnp.extensions.standard.services.UPnP',
 'packages.akit.interop.upnp.generator',
 'packages.akit.interop.upnp.generator.dynamic',
 'packages.akit.interop.upnp.services',
 'packages.akit.interop.upnp.xml',
 'packages.akit.interop.wireless',
 'packages.akit.monitoring',
 'packages.akit.networking',
 'packages.akit.readers',
 'packages.akit.readers.linux',
 'packages.akit.readers.linux.command',
 'packages.akit.templates',
 'packages.akit.testing',
 'packages.akit.testing.testplus',
 'packages.akit.testing.testplus.registration',
 'packages.akit.workflow',
 'packages.akit.workflow.tasks',
 'packages.akit.xlogging',
 'packages.akit.xml',
 'packages.akit.xmultiprocessing',
 'packages.akit.xregex',
 'packages.akit.xthreading']

package_data = \
{'': ['*'],
 'packages.akit.interop': ['soap/*'],
 'packages.akit.interop.upnp.generator': ['standard/embeddeddevices/UPnP/*',
                                          'standard/services/UPnP/*'],
 'packages.akit.interop.upnp.generator.dynamic': ['embeddeddevices/NETGEAR/*',
                                                  ...
                                                  'services/NETGEARInc/*',
                                                  'services/SonosInc/*'],
 'packages.akit.monitoring': ['scripts/platforms/linux/*', 'templates/*'],
 'packages.akit.templates': ['static/v0/*', 'tabs/*']}
