...
class Settings(BaseSettings):
    ...
    WS_IDENTIFIER: str = "wss://6y2y5ycu0b.execute-api.eu-central-1.amazonaws.com/v1"
    # REST API Gateway # TODO: Point to develop environment
    REST_API_LOGIN: str = "https://50igwawvc1.execute-api.eu-central-1.amazonaws.com/"
    REST_API_URL_GET: str = "https://50igwawvc1.execute-api.eu-central-1.amazonaws.com/"
