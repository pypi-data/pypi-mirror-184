...
class Document:
    ...
    def path(self) -> Optional[str]:
        """
        The full path associated with this document, or none.
        """
        return self._path
    ...
    def title(self):
        """
        The title of this document, or none.
        """
        return self._title
    ...
    def OnCreate(self, path, flags):
        ...
        if flags & DOC_NO_VIEW:
            ...
            result = self.template.CreateView(self, flags)
    ...
    def askForReload(self, message=None):
        if self.canReload:
            if message is None:
                message = (
