...
from ..applicationWindow import FileDropTarget
...
class STCdropTarget(wx.DropTarget):
    ...
    def __init__(self, stc):
        ...
        self.control = stc
        self.data = {"data": None, "text_data": None, "file_data": None}
        self.initObjects()
    ...
    def initObjects(self):
        self.data["data"] = wx.DataObjectComposite()
        self.data["text_data"] = wx.TextDataObject()
        self.data["file_data"] = wx.FileDataObject()
...
class STCfoldMixin(object):
    ...
    def defineFoldMarker(self, style, line, fill, highlight):
        ...
        if style == box:
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDEROPEN, stc.STC_MARK_BOXMINUS, _fill, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDER, stc.STC_MARK_BOXPLUS, _highlight, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDERSUB, stc.STC_MARK_VLINE, _fill, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDERTAIL, stc.STC_MARK_LCORNER, _fill, _line
            )
            self.MarkerDefine(
            ...
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDERMIDTAIL, stc.STC_MARK_TCORNER, _fill, _line
            )
        elif style == circle:
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDEROPEN, stc.STC_MARK_CIRCLEMINUS, _fill, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDER, stc.STC_MARK_CIRCLEPLUS, _highlight, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDERSUB, stc.STC_MARK_VLINE, _fill, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDERTAIL, stc.STC_MARK_LCORNERCURVE, _fill, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDEREND,
            ...
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDERMIDTAIL, stc.STC_MARK_TCORNERCURVE, _fill, _line
            )
        elif style == arrow:
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDEROPEN, stc.STC_MARK_ARROWDOWN, _line, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDER, stc.STC_MARK_ARROW, _highlight, _highlight
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDERSUB, stc.STC_MARK_EMPTY, _line, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDERTAIL, stc.STC_MARK_EMPTY, _line, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDEREND, stc.STC_MARK_EMPTY, _line, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDEROPENMID, stc.STC_MARK_EMPTY, _line, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDERMIDTAIL, stc.STC_MARK_EMPTY, _line, _line
            )
        elif style == plusminus:
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDEROPEN, stc.STC_MARK_MINUS, _line, _line
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDER, stc.STC_MARK_PLUS, _highlight, _highlight
            )
            self.MarkerDefine(
                stc.STC_MARKNUM_FOLDERSUB, stc.STC_MARK_EMPTY, _line, _line
            )
