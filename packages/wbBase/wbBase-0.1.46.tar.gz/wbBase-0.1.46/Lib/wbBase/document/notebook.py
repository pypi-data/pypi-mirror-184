...
class NotebookTabArt(aui.AuiDefaultTabArt):
    # def DrawTab(self, dc, wnd, page, rect, close_button_state, out_tab_rect, out_button_rect, x_extent):
    #     # print("page :", page)
    #     # print("rect :", rect)
    #     # print("close_button_state :", close_button_state)
    #     # print("out_tab_rect :", out_tab_rect)
    #     # print("out_button_rect :", out_button_rect)
    #     # print("x_extent :", x_extent)
    #     super().DrawTab(dc, wnd, page, rect, close_button_state, out_tab_rect, out_button_rect, x_extent)
...
class DocumentNotebook(aui.AuiNotebook):
    def __init__(
        ...
        # self.SetArtProvider(NotebookTabArt())
    ...
    def AddPage(self, page, caption, select=False, bitmap=None) -> bool:
