...
__all__ = ["ct", "mstate", "mv", "mvr", "pwa", "pwm", "repeat", "set_lim",
           "set_lm", "set_pos", "set_user_pos", "uct", "umv", "umvr", "wa", "wm",
...
class set_user_pos(Macro):
    ...
    param_def = [
        ['motor', Type.Motor, None, 'Motor name'],
        ['pos',   Type.Float, None, 'Position to move to'],
        ['update_limit', Type.Boolean, True, 'Update the software limit, enabled by default']
    ]
    ...
    def run(self, motor, pos, update_limit):
        ...
        if update_limit is True:
            ...
            self.set_lim(motor, new_low, new_high)
