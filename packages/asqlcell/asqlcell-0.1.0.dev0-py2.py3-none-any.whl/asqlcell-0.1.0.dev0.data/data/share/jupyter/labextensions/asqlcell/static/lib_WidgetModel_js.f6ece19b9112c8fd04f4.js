...
const table_1 = __webpack_require__(/*! ./components/table */ "./lib/components/table.js");
const vsc_1 = __webpack_require__(/*! react-icons/vsc */ "./node_modules/react-icons/vsc/index.esm.js");
const dataimport_1 = __webpack_require__(/*! ./components/dataimport */ "./lib/components/dataimport.js");
const ReactWidget = (props) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
    const [hist, setHist] = react_1.useState([{ columnName: "", bins: [{ bin_start: 0, bin_end: 0, count: 0 }] }]);
    ...
    const latestCallback = react_1.useRef(() => {
    });
    react_1.useEffect(() => {
    ...
    return (react_1.default.createElement("div", { className: "Widget" },
        react_1.default.createElement(core_1.Stack, { spacing: 0, align: "center" },
            show ?
                react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(core_1.Group, { position: "apart", align: "center", sx: {
                        ...
                        react_1.default.createElement(dataimport_1.DataImport, { model: props.model }),
            ...
            react_1.default.createElement(core_1.Group, { sx: { width: "95%" }, position: "center" }, data ?
                react_1.default.createElement(table_1.DataTable, { data: data, model: props.model, page: page, setPage: setPage, rowNumber: rowNumber, setRowNumber: setRowNumber, hist: hist })
                :
...
const DataTable = ({ data, model, page, setPage, rowNumber, setRowNumber, hist }) => {
    ...
    const rows = [...Array(info.index.length).keys()].map((index) => (react_2.default.createElement("tr", { key: base_1.uuid() },
        ...
        info.data[index].map((item) => (react_2.default.createElement("td", { style: { fontSize: "12px" } }, typeof (item) === "boolean" ?
            item ?
                "True"
                :
                    "False"
            ...
            react_2.default.createElement(core_1.Table, { withBorder: true, withColumnBorders: true, striped: true, sx: {
                ...
                react_2.default.createElement("thead", null,
                    react_2.default.createElement("tr", null,
                        ...
                        header.map((item, index) => react_2.default.createElement("th", { style: {
                                textAlign: "center",
                                padding: 0,
                            } },
                            react_2.default.createElement(core_1.Button, { color: "dark", sx: {
                                    width: "100%",
                                    height: "27px",
                                    ...
                                    order === Order.Increasing ?
                                        react_2.default.createElement(fa_1.FaSortUp, { color: "gray", size: 10 })
                                        :
                                            order === Order.Descending ?
                                                react_2.default.createElement(fa_1.FaSortDown, { color: "gray", size: 10 })
                                                :
                                                    react_2.default.createElement(fa_1.FaSort, { color: "lightgray", size: 10 })
                                    :
                                        react_2.default.createElement(fa_1.FaSort, { color: "lightgray", size: 10 }), variant: "subtle", onClick: () => {
                                    if (col === item) {
