...
class CreateRequestClient:
    ...
    def QueryAccountDetails(self) -> responseModels.AccountDetailsResponseModel:
    ...
    def BlacklistCustomized(self, request: models.BlacklistRequestModel) -> responseModels.BaseResponseModel:
