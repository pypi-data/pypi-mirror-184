...
class HeroSummoning(ABIWrapperContract):
    ...
    def initialize(self, cred:Credentials, _crystal_core_address:address, _hero_core_address:address, _power_token_address:address, _gaia_tears_address:address, _stat_science_address:address) -> TxReceipt:
        tx = self.contract.functions.initialize(_crystal_core_address, _hero_core_address, _power_token_address, _gaia_tears_address, _stat_science_address)
        return self.send_transaction(tx, cred)
