...
class WorkerNodeType(object):
    ...
    def __init__(self, name=None, instance_type=None, resources=None, aws_advanced_configurations_json=None, aws_advanced_configurations=None, gcp_advanced_configurations_json=None, gcp_advanced_configurations=None, min_workers=None, max_workers=None, use_spot=False, local_vars_configuration=None):  # noqa: E501
