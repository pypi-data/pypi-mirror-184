...
def setup(request, pytestconfig):
    ...
    if current_marker == CONFIG.MARKERS_NOGUI:
        ...
        G_REPORT_RUNTIME[CONFIG.URL] = os.environ["url"] # pytestconfig.getoption(CONFIG.APP_LINK)
        G_REPORT_RUNTIME[CONFIG.APP_NAME] = os.environ["app"] # pytestconfig.getoption(CONFIG.APP_NAME)
        G_REPORT_RUNTIME[CONFIG.USERNAME] = os.environ["username"] # pytestconfig.getoption(CONFIG.USERNAME)
