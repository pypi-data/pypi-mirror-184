...
Maybe<bool> Equal(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& other);
...
Maybe<one::Tensor> LogSumExp(const std::shared_ptr<one::Tensor>& x, const std::vector<int32_t>& dim, bool keepdim);

Maybe<one::Tensor> LogAddExp(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& y);

Maybe<one::Tensor> Quantile(const std::shared_ptr<one::Tensor>& x, const Scalar& q, int32_t dim, bool keepdim, const std::string& interpolation, const Optional<one::Tensor>& out);
...
Maybe<one::Tensor> AsStrided(const std::shared_ptr<one::Tensor>& input, const std::vector<int64_t>& size, const std::vector<int64_t>& stride, int64_t storage_offset);

Maybe<one::Tensor> AsStridedGrad(const std::shared_ptr<one::Tensor>& dy, const std::shared_ptr<one::Tensor>& input, const std::vector<int64_t>& size, const std::vector<int64_t>& stride, int64_t storage_offset);
...
Maybe<one::Tensor> FastGelu(const std::shared_ptr<one::Tensor>& x);

Maybe<one::Tensor> FastGeluGrad(const std::shared_ptr<one::Tensor>& dy, const std::shared_ptr<one::Tensor>& x);

Maybe<one::Tensor> QuickGelu(const std::shared_ptr<one::Tensor>& x);

Maybe<one::Tensor> QuickGeluGrad(const std::shared_ptr<one::Tensor>& dy, const std::shared_ptr<one::Tensor>& x);
...
Maybe<one::Tensor> FusedGlu(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& w, const std::shared_ptr<one::Tensor>& b, const Optional<one::Tensor>& v, const Optional<one::Tensor>& c, const std::string& activation);
...
Maybe<one::Tensor> GumbelSoftmax(const std::shared_ptr<one::Tensor>& x, double tau, const Optional<int64_t>& dim, bool hard, const Optional<one::Generator>& generator);
...
Maybe<one::Tensor> GlobalTensorConstant(const Shape& shape, const std::shared_ptr<one::Tensor>& value, const Symbol<DType>& dtype, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp);

Maybe<one::Tensor> TensorConstant(const Shape& shape, const std::shared_ptr<one::Tensor>& value, const Symbol<DType>& dtype, const Optional<Symbol<Device>>& device);
...
Maybe<one::Tensor> Conv1d(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& weight, const Optional<one::Tensor>& bias, const std::vector<int32_t>& stride, const std::vector<int32_t>& padding, const std::vector<int32_t>& dilation, int32_t groups, const std::string& channel_pos);

Maybe<one::Tensor> Conv2d(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& weight, const Optional<one::Tensor>& bias, const std::vector<int32_t>& stride, const std::vector<int32_t>& padding, const std::vector<int32_t>& dilation, int32_t groups, const std::string& channel_pos);

Maybe<one::Tensor> Conv3d(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& weight, const Optional<one::Tensor>& bias, const std::vector<int32_t>& stride, const std::vector<int32_t>& padding, const std::vector<int32_t>& dilation, int32_t groups, const std::string& channel_pos);
...
Maybe<one::Tensor> Deconv1d(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& weight, const Optional<one::Tensor>& bias, const std::vector<int32_t>& stride, const std::vector<int32_t>& padding, const std::vector<int32_t>& output_padding, int32_t groups, const std::vector<int32_t>& dilation, const std::string& data_format);

Maybe<one::Tensor> Deconv2d(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& weight, const Optional<one::Tensor>& bias, const std::vector<int32_t>& stride, const std::vector<int32_t>& padding, const std::vector<int32_t>& output_padding, int32_t groups, const std::vector<int32_t>& dilation, const std::string& data_format);

Maybe<one::Tensor> Deconv3d(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& weight, const Optional<one::Tensor>& bias, const std::vector<int32_t>& stride, const std::vector<int32_t>& padding, const std::vector<int32_t>& output_padding, int32_t groups, const std::vector<int32_t>& dilation, const std::string& data_format);
...
Maybe<one::Tensor> FusedMatmulBias(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& weight, const std::shared_ptr<one::Tensor>& bias, const Optional<one::Tensor>& _add_to_output);
...
Maybe<one::Tensor> BaddBmm(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& batch1, const std::shared_ptr<one::Tensor>& batch2, double beta, double alpha);
...
Maybe<one::Tensor> RMSNorm(const std::shared_ptr<one::Tensor>& x, const Optional<one::Tensor>& weight, const Shape& normalized_shape, float epsilon);

Maybe<one::Tensor> RMSNormGrad(const std::shared_ptr<one::Tensor>& dy, const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& inv_rms, const Optional<one::Tensor>& weight, bool param_grad);

Maybe<one::Tensor> GroupNorm(const std::shared_ptr<one::Tensor>& x, const Optional<one::Tensor>& gamma, const Optional<one::Tensor>& beta, bool affine, int32_t num_groups, double epsilon, const std::string& data_format, const std::string& activation);
...
Maybe<one::Tensor> MaxUnpool1D(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& indices, const std::vector<int32_t>& kernel_size, const Optional<std::vector<int32_t>>& stride, const std::vector<int32_t>& padding, const Optional<Shape>& output_size);

Maybe<one::Tensor> MaxUnpool2D(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& indices, const std::vector<int32_t>& kernel_size, const Optional<std::vector<int32_t>>& stride, const std::vector<int32_t>& padding, const Optional<Shape>& output_size);

Maybe<one::Tensor> MaxUnpool3D(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& indices, const std::vector<int32_t>& kernel_size, const Optional<std::vector<int32_t>>& stride, const std::vector<int32_t>& padding, const Optional<Shape>& output_size);

Maybe<one::Tensor> MaxUnpool1dGrad(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& indice, const std::shared_ptr<one::Tensor>& dy);

Maybe<one::Tensor> MaxUnpool2dGrad(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& indice, const std::shared_ptr<one::Tensor>& dy);

Maybe<one::Tensor> MaxUnpool3dGrad(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& indice, const std::shared_ptr<one::Tensor>& dy);
...
Maybe<one::TensorTuple> FusedGetBounddingBoxesCoord(const std::shared_ptr<one::Tensor>& x1, const std::shared_ptr<one::Tensor>& y1, const std::shared_ptr<one::Tensor>& w1, const std::shared_ptr<one::Tensor>& h1, const std::shared_ptr<one::Tensor>& x2, const std::shared_ptr<one::Tensor>& y2, const std::shared_ptr<one::Tensor>& w2, const std::shared_ptr<one::Tensor>& h2);

Maybe<one::TensorTuple> FusedGetBounddingBoxesCoordGrad(const std::shared_ptr<one::Tensor>& b1_x1_diff, const std::shared_ptr<one::Tensor>& b1_x2_diff, const std::shared_ptr<one::Tensor>& b1_y1_diff, const std::shared_ptr<one::Tensor>& b1_y2_diff, const std::shared_ptr<one::Tensor>& b2_x1_diff, const std::shared_ptr<one::Tensor>& b2_x2_diff, const std::shared_ptr<one::Tensor>& b2_y1_diff, const std::shared_ptr<one::Tensor>& b2_y2_diff);

Maybe<one::TensorTuple> FusedGetCiouResult(const std::shared_ptr<one::Tensor>& v, const std::shared_ptr<one::Tensor>& iou, const std::shared_ptr<one::Tensor>& rho2, const std::shared_ptr<one::Tensor>& c2, float eps);

Maybe<one::TensorTuple> FusedGetCiouResultGrad(const std::shared_ptr<one::Tensor>& dy, const std::shared_ptr<one::Tensor>& alpha, const std::shared_ptr<one::Tensor>& rho2, const std::shared_ptr<one::Tensor>& c2);

Maybe<one::Tensor> FusedGetIou(const std::shared_ptr<one::Tensor>& w1, const std::shared_ptr<one::Tensor>& h1, const std::shared_ptr<one::Tensor>& w2, const std::shared_ptr<one::Tensor>& h2, const std::shared_ptr<one::Tensor>& inter, float eps);

Maybe<one::TensorTuple> FusedGetIouGrad(const std::shared_ptr<one::Tensor>& diou, const std::shared_ptr<one::Tensor>& w1, const std::shared_ptr<one::Tensor>& h1, const std::shared_ptr<one::Tensor>& w2, const std::shared_ptr<one::Tensor>& h2, const std::shared_ptr<one::Tensor>& inter, float eps);
...
Maybe<one::Tensor> CommBroadcast(const std::shared_ptr<one::Tensor>& x, int64_t src_rank, bool inplace);

Maybe<one::TensorTuple> CommBroadcastTensors(const TensorTuple& inputs, int64_t src_rank, bool inplace);

Maybe<one::Tensor> LocalAllReduce(const std::shared_ptr<one::Tensor>& x, bool inplace);

Maybe<one::Tensor> LocalAllGather(const std::shared_ptr<one::Tensor>& output, const std::shared_ptr<one::Tensor>& input);

Maybe<one::Tensor> LocalReduceScatter(const std::shared_ptr<one::Tensor>& output, const std::shared_ptr<one::Tensor>& input);
...
Maybe<one::TensorTuple> FusedBiasAddScaleMaskSoftmaxDropout(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& bias, const std::shared_ptr<one::Tensor>& mask, float fill_value, float scale, float p, bool training, const Optional<one::Generator>& generator);
...
Maybe<one::Tensor> FusedCenter(const std::shared_ptr<one::Tensor>& b1_x1, const std::shared_ptr<one::Tensor>& b1_x2, const std::shared_ptr<one::Tensor>& b2_x1, const std::shared_ptr<one::Tensor>& b2_x2, const std::shared_ptr<one::Tensor>& b1_y1, const std::shared_ptr<one::Tensor>& b1_y2, const std::shared_ptr<one::Tensor>& b2_y1, const std::shared_ptr<one::Tensor>& b2_y2);

Maybe<one::TensorTuple> FusedCenterGrad(const std::shared_ptr<one::Tensor>& b1_x1, const std::shared_ptr<one::Tensor>& b1_x2, const std::shared_ptr<one::Tensor>& b2_x1, const std::shared_ptr<one::Tensor>& b2_x2, const std::shared_ptr<one::Tensor>& b1_y1, const std::shared_ptr<one::Tensor>& b1_y2, const std::shared_ptr<one::Tensor>& b2_y1, const std::shared_ptr<one::Tensor>& b2_y2, const std::shared_ptr<one::Tensor>& rho2_diff);

Maybe<one::Tensor> FusedGetIntersectionArea(const std::shared_ptr<one::Tensor>& b1_x1, const std::shared_ptr<one::Tensor>& b1_x2, const std::shared_ptr<one::Tensor>& b2_x1, const std::shared_ptr<one::Tensor>& b2_x2, const std::shared_ptr<one::Tensor>& b1_y1, const std::shared_ptr<one::Tensor>& b1_y2, const std::shared_ptr<one::Tensor>& b2_y1, const std::shared_ptr<one::Tensor>& b2_y2);

Maybe<one::TensorTuple> FusedGetIntersectionAreaGrad(const std::shared_ptr<one::Tensor>& b1_x1, const std::shared_ptr<one::Tensor>& b1_x2, const std::shared_ptr<one::Tensor>& b2_x1, const std::shared_ptr<one::Tensor>& b2_x2, const std::shared_ptr<one::Tensor>& b1_y1, const std::shared_ptr<one::Tensor>& b1_y2, const std::shared_ptr<one::Tensor>& b2_y1, const std::shared_ptr<one::Tensor>& b2_y2, const std::shared_ptr<one::Tensor>& inter_diff);

Maybe<one::Tensor> FusedGetCiouDiagonalAngle(const std::shared_ptr<one::Tensor>& w1, const std::shared_ptr<one::Tensor>& h1, const std::shared_ptr<one::Tensor>& w2, const std::shared_ptr<one::Tensor>& h2, float eps);

Maybe<one::TensorTuple> FusedGetCiouDiagonalAngleGrad(const std::shared_ptr<one::Tensor>& w1, const std::shared_ptr<one::Tensor>& h1, const std::shared_ptr<one::Tensor>& w2, const std::shared_ptr<one::Tensor>& h2, const std::shared_ptr<one::Tensor>& v_diff, float eps);

Maybe<one::Tensor> FusedGetConvexDiagonalSquared(const std::shared_ptr<one::Tensor>& b1_x1, const std::shared_ptr<one::Tensor>& b1_x2, const std::shared_ptr<one::Tensor>& b2_x1, const std::shared_ptr<one::Tensor>& b2_x2, const std::shared_ptr<one::Tensor>& b1_y1, const std::shared_ptr<one::Tensor>& b1_y2, const std::shared_ptr<one::Tensor>& b2_y1, const std::shared_ptr<one::Tensor>& b2_y2, float eps);

Maybe<one::TensorTuple> FusedGetConvexDiagonalSquaredGrad(const std::shared_ptr<one::Tensor>& c2_diff, const std::shared_ptr<one::Tensor>& b1_x1, const std::shared_ptr<one::Tensor>& b1_x2, const std::shared_ptr<one::Tensor>& b2_x1, const std::shared_ptr<one::Tensor>& b2_x2, const std::shared_ptr<one::Tensor>& b1_y1, const std::shared_ptr<one::Tensor>& b1_y2, const std::shared_ptr<one::Tensor>& b2_y1, const std::shared_ptr<one::Tensor>& b2_y2, float eps);

Maybe<one::TensorTuple> GroupedMatmulBias(const TensorTuple& xs, const TensorTuple& weights, const TensorTuple& biases);

Maybe<one::TensorTuple> GroupedMatmul(const TensorTuple& xs, const TensorTuple& weights);
...
Maybe<one::TensorTuple> TopK(const std::shared_ptr<one::Tensor>& input, int32_t k, int32_t dim, bool largest, bool sorted);
...
Maybe<one::Tensor> IndexAdd(const std::shared_ptr<one::Tensor>& input, int64_t dim, const std::shared_ptr<one::Tensor>& index, const std::shared_ptr<one::Tensor>& source, const Scalar& alpha);

Maybe<one::Tensor> IndexAddInplace(const std::shared_ptr<one::Tensor>& input, int64_t dim, const std::shared_ptr<one::Tensor>& index, const std::shared_ptr<one::Tensor>& source, const Scalar& alpha);
...
Maybe<void> MultiTensorYoloV5WeightUpdate(const TensorTuple& model, const TensorTuple& model_update, float d);

Maybe<void> MultiTensorMomentumUpdate(const TensorTuple& model, const TensorTuple& model_diff, const TensorTuple& momentum_buf, double scale, float weight_decay, float learning_rate_val, float momentum, float dampening, bool nesterov, bool maximize);
...
Maybe<Shape> BroadcastShapes(const std::vector<Shape>& shapes);

Maybe<one::TensorTuple> BroadcastTensors(const TensorTuple& tensors);

Maybe<one::Tensor> BroadcastTo(const std::shared_ptr<one::Tensor>& x, const Shape& shape);
...
Maybe<one::Tensor> Stft(const std::shared_ptr<one::Tensor>& input, int64_t n_fft, const Optional<int64_t>& hop_length, const Optional<int64_t>& win_length, const Optional<one::Tensor>& window, bool center, const std::string& pad_mode, bool normalized, bool onesided, bool return_complex);

Maybe<one::Tensor> IsClose(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& other, float atol, float rtol, bool equal_nan);

Maybe<one::Tensor> InplaceUniform(const std::shared_ptr<one::Tensor>& x, const Scalar& from, const Scalar& to);

Maybe<one::Tensor> FusedFastGeluMul(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& multiplier);

Maybe<one::TensorTuple> FusedFastGeluMulGrad(const std::shared_ptr<one::Tensor>& dy, const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& multiplier);

Maybe<one::Tensor> Unique(const std::shared_ptr<one::Tensor>& x, bool sorted, const Symbol<DType>& dtype);

Maybe<one::TensorTuple> UniqueWithCounts(const std::shared_ptr<one::Tensor>& x, bool sorted, bool return_inverse, bool return_counts, const Symbol<DType>& dtype);

Maybe<one::Tensor> FusedWeightedSum(const TensorTuple& in, const std::vector<float>& weights, float alpha);

Maybe<one::TensorTuple> Sort(const std::shared_ptr<one::Tensor>& input, int32_t dim, bool descending);

Maybe<one::Tensor> ThrowError(const std::shared_ptr<one::Tensor>& input);
