...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='oneflow/core/common/shape.proto',
  package='oneflow',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n\x1foneflow/core/common/shape.proto\x12\x07oneflow\"\x19\n\nShapeProto\x12\x0b\n\x03\x64im\x18\x01 \x03(\x03')
)
...
_SHAPEPROTO = _descriptor.Descriptor(
  name='ShapeProto',
  full_name='oneflow.ShapeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim', full_name='oneflow.ShapeProto.dim', index=0,
...
ShapeProto = _reflection.GeneratedProtocolMessageType('ShapeProto', (_message.Message,), {
  ...
  '__module__' : 'oneflow.core.common.shape_pb2'
