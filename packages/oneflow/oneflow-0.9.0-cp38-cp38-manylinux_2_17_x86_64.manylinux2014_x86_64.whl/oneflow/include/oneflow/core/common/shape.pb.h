...
class ShapeProto :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_oneflow_2fcore_2fcommon_2fshape_2eproto);
    return ::descriptor_table_oneflow_2fcore_2fcommon_2fshape_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ShapeProto::dim(int index) const {
  // @@protoc_insertion_point(field_get:oneflow.ShapeProto.dim)
  return dim_.Get(index);
}
inline void ShapeProto::set_dim(int index, ::PROTOBUF_NAMESPACE_ID::int64 value) {
  dim_.Set(index, value);
  // @@protoc_insertion_point(field_set:oneflow.ShapeProto.dim)
}
inline void ShapeProto::add_dim(::PROTOBUF_NAMESPACE_ID::int64 value) {
  dim_.Add(value);
