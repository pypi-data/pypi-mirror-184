...
namespace oneflow {
class RangeProto;
class RangeProtoDefaultTypeInternal;
...
class RangeProto :
 ...
 public:
  ...
  inline RangeProto* New() const final {
    return CreateMaybeMessage<RangeProto>(nullptr);
  }

  RangeProto* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_oneflow_2fcore_2fcommon_2frange_2eproto);
    return ::descriptor_table_oneflow_2fcore_2fcommon_2frange_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int64 RangeProto::begin() const {
  // @@protoc_insertion_point(field_get:oneflow.RangeProto.begin)
  return begin_;
}
inline void RangeProto::set_begin(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000001u;
  begin_ = value;
...
inline ::PROTOBUF_NAMESPACE_ID::int64 RangeProto::end() const {
  // @@protoc_insertion_point(field_get:oneflow.RangeProto.end)
  return end_;
}
inline void RangeProto::set_end(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000002u;
  end_ = value;
