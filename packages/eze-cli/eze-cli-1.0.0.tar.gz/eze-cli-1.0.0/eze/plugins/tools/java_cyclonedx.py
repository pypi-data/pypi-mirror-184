...
"""
    ...
    EZE_CONFIG: dict = {
        "REPORT_FILE": {
            "type": str,
            "default": "__ABSOLUTE_CWD__.eze/raw/_java-cyclonedx-bom.json",
            "default_help_value": "<cwd>.eze/raw/_java-cyclonedx-bom.json",
    ...
    async def run_scan(self) -> ScanResult:
        ...
        for pom_file in pom_files:
            ...
            self.config["__FORCED_DOCKER_SOURCE_FOLDER"] = str(maven_project_fullpath)
