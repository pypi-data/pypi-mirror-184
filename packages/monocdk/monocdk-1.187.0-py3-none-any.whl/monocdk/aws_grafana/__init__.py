...
class CfnWorkspace(
    ...
    def __init__(
        ...
        *,
        ...
        :param vpc_configuration: ``AWS::Grafana::Workspace.VpcConfiguration``.
        '''
        if __debug__:
    ...
    class VpcConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param security_group_ids: ``CfnWorkspace.VpcConfigurationProperty.SecurityGroupIds``.
            :param subnet_ids: ``CfnWorkspace.VpcConfigurationProperty.SubnetIds``.
