...
class SingleUserModeSettings(ModelNormal):
    ...
    attribute_map = {
        'trial_started': 'trialStarted',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, trial_started, first_name, last_name, email, *args, **kwargs):  # noqa: E501
        """SingleUserModeSettings - a model defined in OpenAPI
