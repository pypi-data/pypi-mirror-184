...
class UpdateDashboardParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, dashboard_id, name, items, *args, **kwargs):  # noqa: E501
        """UpdateDashboardParams - a model defined in OpenAPI
