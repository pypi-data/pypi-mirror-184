...
class FilParser:
    ...
    _records: list
    _model: Model
    _curr_elem_out = cython.declare(int, visibility='public')
    _curr_step = cython.declare(int, visibility='public')
    _curr_inc = cython.declare(int, visibility='public')
    _curr_loc_id = cython.declare(int, visibility='public')
    _curr_n_int_point: cython.declare(int, visibility='public')
    _flag_output: cython.declare(int, visibility='public')
    _curr_output_node: cython.declare(int, visibility='public')
    _output_request_set: str
    _output_elem_type: str
    _dof_map: dict
    _model_dimension: cython.declare(int, visibility='public')
    _node_records: list
    _curr_set: cython.declare(int, visibility='public')
    _tmp_sets: dict
    _label_cross_ref: dict
    _curr_surface: cython.declare(int, visibility='public')
    _tmp_surf: dict
    _tmp_faces: dict
    _node_elems: dict
    ...
    def _reference_elems_in_nodes(self):
        ...
        model = self._model
        ni: cython.int = 1
        cdef int[:] nodes = list(self._node_elems.keys())
