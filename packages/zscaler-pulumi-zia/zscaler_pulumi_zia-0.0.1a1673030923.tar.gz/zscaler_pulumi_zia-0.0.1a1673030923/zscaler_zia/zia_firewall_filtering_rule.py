...
class ZIAFirewallFilteringRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] dest_countries: Destination countries for which the rule is applicable. If not set, the rule is not restricted to specific destination
               countries.
        :param pulumi.Input['ZIAFirewallFilteringRuleDestIpGroupsArgs'] dest_ip_groups: list of dest ip groups
...
class ZIAFirewallFilteringRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] dest_countries: Destination countries for which the rule is applicable. If not set, the rule is not restricted to specific destination
               countries.
        :param pulumi.Input[pulumi.InputType['ZIAFirewallFilteringRuleDestIpGroupsArgs']] dest_ip_groups: list of dest ip groups
    ...
    @property
    @pulumi.getter(name="enableFullLogging")
    def enable_full_logging(self) -> pulumi.Output[bool]:
        return pulumi.get(self, "enable_full_logging")
