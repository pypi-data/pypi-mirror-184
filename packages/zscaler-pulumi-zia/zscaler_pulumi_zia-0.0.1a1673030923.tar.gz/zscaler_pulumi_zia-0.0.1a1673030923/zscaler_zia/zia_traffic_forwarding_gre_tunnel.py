...
class ZIATrafficForwardingGRETunnelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ZIATrafficForwardingGRETunnelPrimaryDestVipArgs']]] primary_dest_vips: The primary destination data center and virtual IP address (VIP) of the GRE tunnel
...
class ZIATrafficForwardingGRETunnel(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[bool] ip_unnumbered: This is required to support the automated SD-WAN provisioning of GRE tunnels, when set to true gre_tun_ip and gre_tun_id are set to null
               * `primary_dest_vip`**` (Optional) The primary destination data center and virtual IP address (VIP) of the GRE tunnel.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZIATrafficForwardingGRETunnelPrimaryDestVipArgs']]]] primary_dest_vips: The primary destination data center and virtual IP address (VIP) of the GRE tunnel
