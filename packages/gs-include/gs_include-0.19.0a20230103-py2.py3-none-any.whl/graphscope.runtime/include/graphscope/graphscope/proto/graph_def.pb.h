...
class MaxGraphInfoPb final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR MaxGraphInfoPb(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MaxGraphInfoPb* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const MaxGraphInfoPb& from) {
    MaxGraphInfoPb::MergeImpl(*this, from);
  }
  private:
...
inline int32_t MaxGraphInfoPb::_internal_last_label_id() const {
  return _impl_.last_label_id_;
}
inline int32_t MaxGraphInfoPb::last_label_id() const {
  // @@protoc_insertion_point(field_get:gs.rpc.graph.MaxGraphInfoPb.last_label_id)
  return _internal_last_label_id();
}
inline void MaxGraphInfoPb::_internal_set_last_label_id(int32_t value) {
  
  _impl_.last_label_id_ = value;
}
inline void MaxGraphInfoPb::set_last_label_id(int32_t value) {
...
inline int32_t MaxGraphInfoPb::_internal_last_property_id() const {
  return _impl_.last_property_id_;
}
inline int32_t MaxGraphInfoPb::last_property_id() const {
  // @@protoc_insertion_point(field_get:gs.rpc.graph.MaxGraphInfoPb.last_property_id)
  return _internal_last_property_id();
}
inline void MaxGraphInfoPb::_internal_set_last_property_id(int32_t value) {
  
  _impl_.last_property_id_ = value;
}
inline void MaxGraphInfoPb::set_last_property_id(int32_t value) {
...
inline int64_t MaxGraphInfoPb::_internal_last_table_id() const {
  return _impl_.last_table_id_;
}
inline int64_t MaxGraphInfoPb::last_table_id() const {
  // @@protoc_insertion_point(field_get:gs.rpc.graph.MaxGraphInfoPb.last_table_id)
  return _internal_last_table_id();
}
inline void MaxGraphInfoPb::_internal_set_last_table_id(int64_t value) {
  
  _impl_.last_table_id_ = value;
}
inline void MaxGraphInfoPb::set_last_table_id(int64_t value) {
