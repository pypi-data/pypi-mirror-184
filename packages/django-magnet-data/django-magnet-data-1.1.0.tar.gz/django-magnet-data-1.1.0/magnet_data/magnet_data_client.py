...
from magnet_data.holidays.models import Holiday
...
class Holidays(Countries):
    ...
    def update(self, country_code: str):
        ...
        if self.last_updated is None or self.last_updated < threshold:
            ...
            Holiday.update_holidays(country_code=country_code.upper())
    ...
    def get_holidays_count_during_weekdays(self,
        ...
        """
        Returns the number of holidays between to days, not considering saturdays
        and sundays
        Keyword arguments:
            country-code -- de ISO 3166 country code
        ...
        holidays_dates = Holiday.objects.filter(
