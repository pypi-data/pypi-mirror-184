...
class Model(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            training_column_info ([ModelColumnInfo]): Additional information/statisics for each column, listed in the order that model was trained on (with descriptor columns first).. [optional]  # noqa: E501
