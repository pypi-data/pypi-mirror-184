...
class SuggestMissingResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            component_index (int): The component of the vector it is suggested to measure (with the first component having `componentIndex=1`).  If the suggested mesurement is not a vector then the `componentIndex` will be 1.. [optional]  # noqa: E501
        """
