...
class OutputToleranceRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, sample_definition, set_inputs, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            num_samples (int): The number of predictions to make during the exploration of the input range space.. [optional] if omitted the server will use the default value of 500  # noqa: E501
        """
