...
class ColumnInfo(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            categories_present ([int]): The categories that are present for this column in the dataset. If the column is empty, will be empty array.. [optional]  # noqa: E501
            mode (int, none_type): The mode of the values appearing in this column in the dataset. If the column is empty, will be set to null.. [optional]  # noqa: E501
            ...
            min (float, none_type): The minimum value appearing in this columm in the dataset. If the column is empty, will be set to null.. [optional]  # noqa: E501
