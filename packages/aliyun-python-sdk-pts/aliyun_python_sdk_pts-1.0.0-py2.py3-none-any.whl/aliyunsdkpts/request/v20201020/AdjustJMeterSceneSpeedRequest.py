...
class AdjustJMeterSceneSpeedRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'PTS', '2020-10-20', 'AdjustJMeterSceneSpeed')
	...
	def get_Speed(self): # Integer
		return self.get_query_params().get('Speed')

	def set_Speed(self, Speed):  # Integer
