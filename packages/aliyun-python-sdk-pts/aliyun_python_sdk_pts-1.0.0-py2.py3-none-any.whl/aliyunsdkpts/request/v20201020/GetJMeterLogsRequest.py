...
class GetJMeterLogsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'PTS', '2020-10-20', 'GetJMeterLogs')
	...
	def get_AgentIndex(self): # Integer
		return self.get_query_params().get('AgentIndex')

	def set_AgentIndex(self, AgentIndex):  # Integer
		self.add_query_param('AgentIndex', AgentIndex)
