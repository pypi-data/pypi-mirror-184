...
class MongoDB(
    ...
    def __init__(self, mongo_config, tooter: Tooter):
        ...
        try:
            ...
            self.collection_accounts_involved_all       = self.db['accounts_involved_all']
            self.collection_accounts_involved_transfer  = self.db['accounts_involved_transfer']
            self.collection_contracts_involved          = self.db['contracts_involved']
