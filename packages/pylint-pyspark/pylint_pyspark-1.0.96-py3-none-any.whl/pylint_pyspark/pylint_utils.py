...
def module_contains_display(expression):
    ...
    for arg in expression.value.args:
        if isinstance(arg.parent, astroid.nodes.Call):
            if hasattr(arg.parent.func, "name") and arg.parent.func.name == "display":
...
def module_contains_show(expression):
    ...
    for arg in expression.value.args:
        if isinstance(arg.parent, astroid.nodes.Call):
            if hasattr(arg.parent.func, "name") and arg.parent.func.name == "show":
...
def module_contains_print(expression):
    ...
    for arg in expression.value.args:
        if isinstance(arg.parent, astroid.nodes.Call):
            if hasattr(arg.parent.func, "name") and arg.parent.func.name == "print":
