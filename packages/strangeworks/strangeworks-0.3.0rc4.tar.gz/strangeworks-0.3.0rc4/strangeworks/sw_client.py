...
from strangeworks.client import jobs, platform, resource, workspace
from strangeworks.client.backends import Backend, get_backend, get_backends
from strangeworks.client.jobs import Job
from strangeworks.client.resource import Resource
from strangeworks.client.rest_client import StrangeworksRestClient
from strangeworks.client.workspace import Workspace
...
class SWClient:
    ...
    def __init__(
        ...
        gql_client: Optional[platform.API] = None,
        **kwargs,
    ) -> None:
        """Strangeworks client.
