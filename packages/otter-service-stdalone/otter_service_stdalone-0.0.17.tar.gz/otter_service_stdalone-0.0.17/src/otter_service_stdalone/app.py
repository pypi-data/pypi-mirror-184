...
class GoogleOAuth2LoginHandler(tornado.web.RequestHandler,
    ...
    async def get(self):
        log.write_logs("3. and 6.", str(self.current_user), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')
        log.write_logs("3. and 6.", str(self.get_argument('code', False)), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')    
        if not self.get_argument('code', False):
            log.write_logs("4.", str(self.current_user), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')
...
class Userform(tornado.web.RequestHandler,
    ...
    async def get(self):
        ...
        log.write_logs("1a.", str(self.current_user), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')
