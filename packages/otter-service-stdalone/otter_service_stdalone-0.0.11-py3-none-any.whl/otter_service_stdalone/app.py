...
class GoogleOAuth2LoginHandler(tornado.web.RequestHandler,
    ...
    async def get(self):
        log.write_logs("3. and 5.", str(self.get_current_user()), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')
        log.write_logs("3. and 5.", str(self.get_argument('code', False)), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')    
...
class Userform(tornado.web.RequestHandler):
    async def get(self):
        ...
        log.write_logs("1b.", str(self.get_argument('code', False)), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')
        if not self.get_argument('code', False) and not self.get_current_user():
            ...
            log.write_logs("5.", str(user), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')
