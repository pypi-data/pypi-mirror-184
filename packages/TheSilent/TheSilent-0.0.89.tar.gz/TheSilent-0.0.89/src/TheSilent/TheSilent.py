...
def shell_injection_scanner(url, secure = True):
    ...
    user_agent_mod = {"User-Agent" : "Mozilla/5.0 (X11; Fedora; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36", "ls /": "ls /"}
    ...
    for link in links:
        ...
        try:
            my_request = web_session.get(link, headers = user_agent_mod, verify = False, timeout = (5,30)).text
