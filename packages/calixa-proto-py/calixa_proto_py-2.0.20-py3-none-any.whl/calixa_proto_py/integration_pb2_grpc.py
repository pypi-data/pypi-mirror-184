...
class ExternalSyncDefinitionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PutSyncDefinition = channel.unary_unary(
                '/calixa.domain.integration.ExternalSyncDefinitionService/PutSyncDefinition',
                request_serializer=integration__pb2.ExternalSyncDefinition.SerializeToString,
                response_deserializer=integration__pb2.ExternalSyncDefinition.FromString,
                )
        self.GetExternalSyncDefinitions = channel.unary_stream(
                '/calixa.domain.integration.ExternalSyncDefinitionService/GetExternalSyncDefinitions',
                request_serializer=integration__pb2.GetExternalSyncDefinitionsRequest.SerializeToString,
                response_deserializer=integration__pb2.ExternalSyncDefinition.FromString,
                )
        self.DeleteExternalSyncDefinition = channel.unary_unary(
                '/calixa.domain.integration.ExternalSyncDefinitionService/DeleteExternalSyncDefinition',
                request_serializer=integration__pb2.DeleteExternalSyncDefinitionRequest.SerializeToString,
...
def add_ExternalSyncDefinitionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PutSyncDefinition': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=integration__pb2.ExternalSyncDefinition.FromString,
                    response_serializer=integration__pb2.ExternalSyncDefinition.SerializeToString,
            ),
            'GetExternalSyncDefinitions': grpc.unary_stream_rpc_method_handler(
                    servicer.GetExternalSyncDefinitions,
                    request_deserializer=integration__pb2.GetExternalSyncDefinitionsRequest.FromString,
                    response_serializer=integration__pb2.ExternalSyncDefinition.SerializeToString,
            ),
            'DeleteExternalSyncDefinition': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteExternalSyncDefinition,
                    request_deserializer=integration__pb2.DeleteExternalSyncDefinitionRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'calixa.domain.integration.ExternalSyncDefinitionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class ExternalSyncDefinitionService(object):
    ...
    def PutSyncDefinition(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.integration.ExternalSyncDefinitionService/PutSyncDefinition',
            integration__pb2.ExternalSyncDefinition.SerializeToString,
            integration__pb2.ExternalSyncDefinition.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetExternalSyncDefinitions(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/calixa.domain.integration.ExternalSyncDefinitionService/GetExternalSyncDefinitions',
            integration__pb2.GetExternalSyncDefinitionsRequest.SerializeToString,
            integration__pb2.ExternalSyncDefinition.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteExternalSyncDefinition(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.integration.ExternalSyncDefinitionService/DeleteExternalSyncDefinition',
            integration__pb2.DeleteExternalSyncDefinitionRequest.SerializeToString,
