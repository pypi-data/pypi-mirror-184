...
# # push_to_gateway('https://pushgateway.svc.ltd', job='batchA', registry=registry)

# r = Gauge('job_last_success_unixtime1', 'Last time a batch job successfully finished1', registry=registry)
# r.set_to_current_time()

# c = generate_latest(registry)
...
if __name__ == "__main__":
    ...
    p = PushGateway("pushgateway.svc.ltd", "test_job")
