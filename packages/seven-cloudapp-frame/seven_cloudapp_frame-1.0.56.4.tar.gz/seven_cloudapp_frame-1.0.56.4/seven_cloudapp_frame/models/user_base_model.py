...
class UserBaseModel(FrameBaseModel):
    ...
    def save_user_by_openid(self, app_id, act_id, open_id, user_nick, avatar, union_id="", login_ip="", is_update_user_nick=True, is_custom_user_id=False):
        """
        ...
        :param is_custom_user_id：是否自定义生成user_id
        :return: 返回用户信息
        :last_editors: HuangJianYi
        """
        ...
        try:
            ...
            if not user_info:
                ...
                if is_custom_user_id == True:
                    user_info.id = SevenHelper.create_order_id()
