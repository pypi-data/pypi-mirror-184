...
class Ui_PresetEchoesPatches(object):
    def setupUi(self, PresetEchoesPatches):
        ...
        self.new_patcher_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
    ...
    def retranslateUi(self, PresetEchoesPatches):
        ...
        self.inverted_check.setText(QCoreApplication.translate("PresetEchoesPatches", u"[Experimental] Inverted Aether", None))
        self.inverted_label.setText(QCoreApplication.translate("PresetEchoesPatches", u"<html><head/><body><p>In this mode, it's the Light Aether atmosphere that is dangerous!<br/>All safe zones are moved to Light Aether, but that's not enough so it's still extremely dangerous.</p><p>This mode has <span style=\" font-weight:700;\">no logic</span>.</p></body></html>", None))
    # retranslateUi
