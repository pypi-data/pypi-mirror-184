...
class Ui_CorruptionGameTabWidget(object):
    def setupUi(self, CorruptionGameTabWidget):
        ...
        self.faq_scroll_area_contents.setGeometry(QRect(0, 0, 629, 465))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 629, 465))
        ...
        self.hint_item_names_scroll_contents.setGeometry(QRect(0, 0, 629, 465))
