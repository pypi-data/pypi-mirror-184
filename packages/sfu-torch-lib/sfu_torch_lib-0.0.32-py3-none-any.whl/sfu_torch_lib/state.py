...
def get_localized_checkpoint_path(run_id: str, filename: str = 'last', overwrite: bool = True) -> Optional[str]:
    checkpoint_path = get_checkpoint_path(run_id, filename)
    checkpoint_path = io.localize_file(checkpoint_path, overwrite=overwrite) if checkpoint_path else None
