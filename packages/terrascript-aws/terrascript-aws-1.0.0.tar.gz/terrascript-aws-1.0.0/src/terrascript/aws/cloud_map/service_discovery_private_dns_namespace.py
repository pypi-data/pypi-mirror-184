...
class ServiceDiscoveryPrivateDnsNamespace(core.Resource):
    ...
    hosted_zone: Union[str, core.StringOut] = core.attr(str, computed=True)
    ...
    vpc: Union[str, core.StringOut] = core.attr(str)
    ...
    class Args(core.Resource.Args):
        ...
        vpc: Union[str, core.StringOut] = core.arg()
