...
@core.schema
class RuleStatementNotStatementStatementOrStatementStatement(core.Schema):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            args=RuleStatementNotStatementStatementOrStatementStatement.Args(
...
class RuleStatementNotStatementStatementOrStatement(core.Schema):
    ...
    statement: Union[
        List[RuleStatementNotStatementStatementOrStatementStatement],
        core.ArrayOut[RuleStatementNotStatementStatementOrStatementStatement],
    ] = core.attr(RuleStatementNotStatementStatementOrStatementStatement, kind=core.Kind.array)
