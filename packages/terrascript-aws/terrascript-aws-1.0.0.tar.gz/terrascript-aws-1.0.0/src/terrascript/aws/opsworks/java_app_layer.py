...
class JavaAppLayer(core.Resource):
    ...
    app_server_version: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)
    ...
    jvm_options: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)

    jvm_type: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)

    jvm_version: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        app_server_version: Optional[Union[str, core.StringOut]] = None,
        ...
        jvm_options: Optional[Union[str, core.StringOut]] = None,
        jvm_type: Optional[Union[str, core.StringOut]] = None,
        jvm_version: Optional[Union[str, core.StringOut]] = None,
    ...
    class Args(core.Resource.Args):
        ...
        app_server_version: Optional[Union[str, core.StringOut]] = core.arg(default=None)
        ...
        jvm_options: Optional[Union[str, core.StringOut]] = core.arg(default=None)

        jvm_type: Optional[Union[str, core.StringOut]] = core.arg(default=None)

        jvm_version: Optional[Union[str, core.StringOut]] = core.arg(default=None)
