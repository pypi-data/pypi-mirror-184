...
class RailsAppLayer(core.Resource):
    ...
    app_server: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)
    ...
    bundler_version: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)
    ...
    manage_bundler: Optional[Union[bool, core.BoolOut]] = core.attr(bool, default=None)

    name: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)

    passenger_version: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)

    ruby_version: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)

    rubygems_version: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        app_server: Optional[Union[str, core.StringOut]] = None,
        ...
        bundler_version: Optional[Union[str, core.StringOut]] = None,
        ...
        manage_bundler: Optional[Union[bool, core.BoolOut]] = None,
        name: Optional[Union[str, core.StringOut]] = None,
        passenger_version: Optional[Union[str, core.StringOut]] = None,
        ruby_version: Optional[Union[str, core.StringOut]] = None,
        rubygems_version: Optional[Union[str, core.StringOut]] = None,
    ...
    class Args(core.Resource.Args):
        app_server: Optional[Union[str, core.StringOut]] = core.arg(default=None)
        ...
        bundler_version: Optional[Union[str, core.StringOut]] = core.arg(default=None)
        ...
        manage_bundler: Optional[Union[bool, core.BoolOut]] = core.arg(default=None)

        name: Optional[Union[str, core.StringOut]] = core.arg(default=None)

        passenger_version: Optional[Union[str, core.StringOut]] = core.arg(default=None)

        ruby_version: Optional[Union[str, core.StringOut]] = core.arg(default=None)

        rubygems_version: Optional[Union[str, core.StringOut]] = core.arg(default=None)
