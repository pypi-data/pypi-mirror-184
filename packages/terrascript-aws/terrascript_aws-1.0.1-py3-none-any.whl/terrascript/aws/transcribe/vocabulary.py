...
class Vocabulary(core.Resource):
    ...
    phrases: Optional[Union[List[str], core.ArrayOut[core.StringOut]]] = core.attr(
    ...
    vocabulary_file_uri: Optional[Union[str, core.StringOut]] = core.attr(
    ...
    def __init__(
        ...
        *,
        ...
        phrases: Optional[Union[List[str], core.ArrayOut[core.StringOut]]] = None,
        tags: Optional[Union[Dict[str, str], core.MapOut[core.StringOut]]] = None,
        tags_all: Optional[Union[Dict[str, str], core.MapOut[core.StringOut]]] = None,
        vocabulary_file_uri: Optional[Union[str, core.StringOut]] = None,
    ...
    class Args(core.Resource.Args):
        ...
        phrases: Optional[Union[List[str], core.ArrayOut[core.StringOut]]] = core.arg(default=None)
        ...
        vocabulary_file_uri: Optional[Union[str, core.StringOut]] = core.arg(default=None)
