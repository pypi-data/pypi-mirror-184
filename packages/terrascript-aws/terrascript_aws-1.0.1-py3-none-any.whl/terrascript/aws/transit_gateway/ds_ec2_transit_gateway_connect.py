...
class DsEc2TransitGatewayConnect(core.Data):
    ...
    transit_gateway_connect_id: Optional[Union[str, core.StringOut]] = core.attr(
        str, default=None, computed=True
    )

    transit_gateway_id: Union[str, core.StringOut] = core.attr(str, computed=True)

    transport_attachment_id: Union[str, core.StringOut] = core.attr(str, computed=True)
    ...
    def __init__(
        ...
        *,
        ...
        transit_gateway_connect_id: Optional[Union[str, core.StringOut]] = None,
    ):
        super().__init__(
            name=data_name,
    ...
    class Args(core.SchemaArgs):
        ...
        transit_gateway_connect_id: Optional[Union[str, core.StringOut]] = core.arg(default=None)
