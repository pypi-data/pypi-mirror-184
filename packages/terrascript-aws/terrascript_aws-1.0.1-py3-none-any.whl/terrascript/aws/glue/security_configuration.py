...
class CloudwatchEncryption(core.Schema):
    ...
    cloudwatch_encryption_mode: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)
    ...
    def __init__(
        self,
        *,
        cloudwatch_encryption_mode: Optional[Union[str, core.StringOut]] = None,
    ...
    class Args(core.SchemaArgs):
        cloudwatch_encryption_mode: Optional[Union[str, core.StringOut]] = core.arg(default=None)
...
class JobBookmarksEncryption(core.Schema):
    ...
    job_bookmarks_encryption_mode: Optional[Union[str, core.StringOut]] = core.attr(
        str, default=None
    )
    ...
    def __init__(
        self,
        *,
        job_bookmarks_encryption_mode: Optional[Union[str, core.StringOut]] = None,
        kms_key_arn: Optional[Union[str, core.StringOut]] = None,
    ):
        super().__init__(
    ...
    @core.schema_args
    class Args(core.SchemaArgs):
        job_bookmarks_encryption_mode: Optional[Union[str, core.StringOut]] = core.arg(default=None)
...
class S3Encryption(core.Schema):
    ...
    s3_encryption_mode: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)

    def __init__(
        self,
        *,
        kms_key_arn: Optional[Union[str, core.StringOut]] = None,
        s3_encryption_mode: Optional[Union[str, core.StringOut]] = None,
    ):
        super().__init__(
    ...
    class Args(core.SchemaArgs):
        ...
        s3_encryption_mode: Optional[Union[str, core.StringOut]] = core.arg(default=None)
