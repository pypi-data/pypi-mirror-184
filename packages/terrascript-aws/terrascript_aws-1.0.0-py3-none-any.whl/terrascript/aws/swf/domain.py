...
class Domain(core.Resource):
    ...
    workflow_execution_retention_period_in_days: Union[str, core.StringOut] = core.attr(str)

    def __init__(
        self,
        resource_name: str,
        *,
        workflow_execution_retention_period_in_days: Union[str, core.StringOut],
    ...
    class Args(core.Resource.Args):
        ...
        workflow_execution_retention_period_in_days: Union[str, core.StringOut] = core.arg()
