...
class NodejsAppLayer(core.Resource):
    ...
    nodejs_version: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        nodejs_version: Optional[Union[str, core.StringOut]] = None,
    ...
    class Args(core.Resource.Args):
        ...
        nodejs_version: Optional[Union[str, core.StringOut]] = core.arg(default=None)
