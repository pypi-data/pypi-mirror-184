...
class DsPrefixList(core.Data):
    ...
    prefix_list_id: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        prefix_list_id: Optional[Union[str, core.StringOut]] = None,
    ):
        super().__init__(
            name=data_name,
    ...
    class Args(core.SchemaArgs):
        ...
        prefix_list_id: Optional[Union[str, core.StringOut]] = core.arg(default=None)
