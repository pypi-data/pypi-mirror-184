...
class DsEngineVersion(core.Data):
    ...
    default_character_set: Union[str, core.StringOut] = core.attr(str, computed=True)
    ...
    """
    supported_character_sets: Union[List[str], core.ArrayOut[core.StringOut]] = core.attr(
        str, computed=True, kind=core.Kind.array
    )
    ...
    """
    supported_feature_names: Union[List[str], core.ArrayOut[core.StringOut]] = core.attr(
        str, computed=True, kind=core.Kind.array
    )
    ...
    """
    supported_modes: Union[List[str], core.ArrayOut[core.StringOut]] = core.attr(
        str, computed=True, kind=core.Kind.array
    )
    ...
    """
    supports_global_databases: Union[bool, core.BoolOut] = core.attr(bool, computed=True)
    ...
    """
    supports_parallel_query: Union[bool, core.BoolOut] = core.attr(bool, computed=True)
