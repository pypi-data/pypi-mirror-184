...
class EventSubscription(core.Resource):
    ...
    severity: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        severity: Optional[Union[str, core.StringOut]] = None,
    ...
    class Args(core.Resource.Args):
        ...
        severity: Optional[Union[str, core.StringOut]] = core.arg(default=None)
