...
from quranic_syntax import root
from quranic_syntax import lemmatizer
...
class NLP():
    ...
    Doc.set_extension("order", default=None)
    Doc.set_extension("soure", default=None)
    Doc.set_extension("ayeh", default=None)
    ...
    def initQuran(doc):
        ...
        if soure:
            ...
            df.index = df['index']
            sent._.order = df.loc[soure]['order_name']
            sent._.soure = df.loc[soure]['soure']
            sent._.ayeh = ayeh
        return sent
