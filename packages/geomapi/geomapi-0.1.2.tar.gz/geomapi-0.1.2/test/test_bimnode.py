...
################################## SETUP/TEARDOWN CLASS ######################
    ...
    def setUpClass(cls):
        ...
        #IFC1 (IfcWall)
        cls.bimGraphPath1=cls.path / 'bimGraph1.ttl'
        ...
        #IFC2 (IfcSite)
        cls.bimGraphPath2=cls.path / 'bimGraph2.ttl'
        ...
        #IFC3 (IfcSlab)
        cls.bimGraphPath3= cls.path / 'bimGraph3.ttl'
        ...
        #IFC4 (IfcDoor)
        cls.bimGraphPath4= cls.path / 'bimGraph4.ttl'
