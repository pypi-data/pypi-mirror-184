...
class VehiclesRepository(AppEntityRepositoryPort, BaseRepository[Vehicle]):
    entity = Vehicle
    ...
    @classmethod
    def get_idp_label_attr(cls) -> str:
        return "label"


class AppEntitiesUnitOfWork(UnitOfWorkPort):
    def __init__(self, session: SessionPort):
        self.session = session
        self.vehicle_repository = VehiclesRepository(session)
