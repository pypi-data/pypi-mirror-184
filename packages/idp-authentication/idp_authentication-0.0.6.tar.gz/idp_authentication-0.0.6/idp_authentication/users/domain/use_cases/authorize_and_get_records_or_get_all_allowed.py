...
class AuthorizeAndGetRecordsOrGetAllAllowedUseCase(BaseUseCase):
    def __init__(
        self,
        users_unit_of_work: unit_of_work.UsersUnitOfWorkPort,
        app_entities_unit_of_work: unit_of_work.UnitOfWorkPort,
        roles: ChoiceEnum,
        authorize_app_entity_records_use_case: UseCasePort,
        get_allowed_app_entity_records_use_case: UseCasePort,
    ):
        super().__init__(
        ...
        self.get_allowed_app_entity_records_use_case = (
            get_allowed_app_entity_records_use_case
        )
    ...
    def execute(
        ...
        if app_entity_records_identifiers:
            ...
            self.get_allowed_app_entity_records_use_case.execute(
                user=user,
                role=role,
                app_entity_type=app_entity_type,
                permission=permission,
