...
def insert_string_in_file_name(file_name: str, insertion: str, ending: str) -> str:
    ...
    The insert_string_in_file_name function takes a file_name and inserts a string into the name.
        ...
        it will be placed at the end of the file_name with an ending specified by you.
    ...
    :param ending:str: Used to Specify the file ending.
    :return: A string.
    ...
    if ending is None and not ext:
        raise ValueError(
            "You must either specify an ending in the file_name or pass an ending through the \
            ending argument. For example the file_name could be 'foo.bar' or you pass \
            file_name'foo' with ending = '.bar'"
        )
...
def check_file_name(file_name: str, ending: str) -> str:
