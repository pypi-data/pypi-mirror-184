...
def remove(db, namespace, tableName):
    ...
    *Overload 1*  
      :param db: (com.illumon.iris.db.tables.databases.Database) - the database object
      :param namespace: (java.lang.String) - namespace of the table
      :param tableName: (java.lang.String) - name of the table
