...
def Agg(*args):
    ...
    *Overload 1*  
      ...
      :return: (com.illumon.iris.db.v2.by.ComboAggregateFactory.ComboBy) a ComboBy object suitable for passing to AggCombo(ComboBy...)
...
def AggCountDistinct(*args):
    ...
    *Overload 1*  
      :param matchPairs: (java.lang.String...) - the columns to apply the aggregation to in the form Output=Input, if the Output and Input have
                         the same name, then the column name can be specified.
      :return: (com.illumon.iris.db.v2.by.ComboAggregateFactory.ComboBy) a ComboBy object suitable for passing to AggCombo(ComboBy...).  Null values are not counted.
...
def AggDistinct(*args):
    ...
    *Overload 1*  
      :param matchPairs: (java.lang.String...) - the columns to apply the aggregation to in the form Output=Input, if the Output and Input have
                         the same name, then the column name can be specified.
      :return: (com.illumon.iris.db.v2.by.ComboAggregateFactory.ComboBy) a ComboBy object suitable for passing to AggCombo(ComboBy...).  Null values are ignored.
...
def AggUnique(*args):
    ...
    *Overload 2*  
      ...
      :param matchPairs: (java.lang.String...) - the columns to apply the aggregation to in the form Output=Input, if the Output and Input have
                         the same name, then the column name can be specified.
      :return: (com.illumon.iris.db.v2.by.ComboAggregateFactory.ComboBy) a ComboBy object suitable for passing to AggCombo(ComboBy...).  Output columns contain null if
