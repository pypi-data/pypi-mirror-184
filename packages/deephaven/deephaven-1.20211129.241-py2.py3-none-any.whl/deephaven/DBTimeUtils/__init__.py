...
def consistentDateNy():
    """
    Convenience method invoking CompositeTableDataServiceConsistencyMonitor.consistentDateNy().
...
def getZonedDateTime(*args):
    ...
    *Overload 2*  
      ...
      :return: (java.time.ZonedDateTime) A ZonedDateTime using the specified time zone. or null if dateTime was null
      
    *Overload 3*  
      :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The a DBDateTime to convert.
      :param timeZone: (java.time.ZoneId) - The ZoneId to use for the conversion.
      :return: (java.time.ZonedDateTime) A ZonedDateTime using the specified time zone. or null if dateTime was null
    """
...
def makeInstant(nanos):
    ...
    :param nanos: (long) - nanoseconds since epoch
    :return: (java.time.Instant) a new Instant or null if nanos was QueryConstants.NULL_LONG.
    """
...
def makeZonedDateTime(*args):
    ...
    *Overload 1*  
      :param nanos: (long) - nanoseconds since epoch
      :return: (java.time.ZonedDateTime) a new ZonedDateTime or null if nanos was QueryConstants.NULL_LONG.
      
    *Overload 2*  
      :param nanos: (long) - nanoseconds since epoch
      :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - the time zone
      :return: (java.time.ZonedDateTime) a new ZonedDateTime or null if nanos was QueryConstants.NULL_LONG.
      
    *Overload 3*  
      :param nanos: (long) - nanoseconds since epoch
      :param zone: (java.time.ZoneId) - the time zone
      :return: (java.time.ZonedDateTime) a new ZonedDateTime or null if nanos was QueryConstants.NULL_LONG.
    """
...
def millisToDateAtMidnight(millis, timeZone):
    """
    Returns a DBDateTime representing midnight in a selected time zone on the date specified by a number of
...
def toEpochNano(value):
    ...
    *Overload 1*  
      :param value: (java.time.Instant) - the instant to convert
      :return: (long) nanoseconds since epoch or null
      
    *Overload 2*  
      :param value: (java.time.ZonedDateTime) - the instant to convert
      :return: (long) nanoseconds since epoch or null
    """
