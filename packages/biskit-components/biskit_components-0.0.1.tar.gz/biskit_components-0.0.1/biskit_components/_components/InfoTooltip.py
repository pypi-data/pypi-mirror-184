...
class InfoTooltip(Component):
    """An InfoTooltip component.
...
- position (a value equal to: 'bottom', 'left', 'right'; optional)
...
- style (dict; optional)
    ...
    - emptyCells (a value equal to: 'show', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'hide'; optional):
    ...
    - textAlign (a value equal to: 'left', 'right', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'center', 'end', 'start', 'justify', 'match-parent'; optional):
...
- targetable (boolean; optional)"""
    ...
    _type = 'InfoTooltip'
    @_explicitize_args
    def __init__(self, children=None, bbox=Component.UNDEFINED, loading_state=Component.UNDEFINED, show=Component.UNDEFINED, hoverable=Component.UNDEFINED, targetable=Component.UNDEFINED, style=Component.UNDEFINED, position=Component.UNDEFINED, id=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'bbox', 'hoverable', 'loading_state', 'position', 'show', 'style', 'targetable']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'bbox', 'hoverable', 'loading_state', 'position', 'show', 'style', 'targetable']
        ...
        super(InfoTooltip, self).__init__(children=children, **args)
