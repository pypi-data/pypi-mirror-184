...
- value (string | list of strings | string; required)
...
- width (string; optional)"""
    ...
    _type = 'SettingSelect'
    @_explicitize_args
    def __init__(self, options=Component.REQUIRED, onClick=Component.UNDEFINED, multiple=Component.UNDEFINED, multipleLabel=Component.UNDEFINED, value=Component.REQUIRED, key=Component.UNDEFINED, disabledValue=Component.UNDEFINED, direction=Component.UNDEFINED, width=Component.UNDEFINED, tooltipPosition=Component.UNDEFINED, dataValue=Component.UNDEFINED, className=Component.UNDEFINED, id=Component.UNDEFINED, **kwargs):
        ...
        for k in ['options', 'value']:
            if k not in args:
                raise TypeError(
                    'Required argument `' + k + '` was not specified.')

        super(SettingSelect, self).__init__(**args)
