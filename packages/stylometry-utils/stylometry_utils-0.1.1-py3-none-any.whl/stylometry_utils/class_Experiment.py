...
class Experiment:
    ...
    if os.getcwd() == "/content":
        platform = "colab"
        nb_name = get('http://172.28.0.2:9000/api/sessions').json()[0]['name'].split(".")[0]
    else:
        platform = "local"
    ...
    @staticmethod
    def create_log_folder(colab_path: str = "/content/drive/MyDrive/stylo_experiments/logs"):
        if os.getcwd() == "/content":
            ...
            Path(current_file.parent / "logs").mkdir(parents=True, exist_ok=True)
