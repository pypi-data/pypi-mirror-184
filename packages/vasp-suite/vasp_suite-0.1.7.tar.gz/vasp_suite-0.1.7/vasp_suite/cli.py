...
def read_args():
    ...
    gen_inp.add_argument(
            'incar_template',
            help="The template (.ini) file the INCAR file will be generated from
                        Use input_config.py to generate a template file",
            type=str,
            default='input.ini'
            )
   ...
   conf.add argument(
    ...
    #select program
    if args.prog in ['generate_input', 'generate_job', 'convert_cif', 'convert_xyz', 'plot_dos', 'generate_config']:
