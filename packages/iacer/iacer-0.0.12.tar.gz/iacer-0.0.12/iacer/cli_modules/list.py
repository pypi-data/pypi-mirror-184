...
from iacer.generate_params import IAC_OCTOPUS_NAME
        ...
        for region_stacks in stacks:
            for stack in region_stacks:
                ...
                for tag in tags:
                    ...
                    elif tag['Key'] == f'{IAC_OCTOPUS_NAME}-id':
