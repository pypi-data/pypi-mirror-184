...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menubar.setGeometry(QRect(0, 0, 2087, 20))
        ...
        self.edit_item_dock_widget.setMaximumSize(QSize(524286, 524287))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 351, 835))
        ...
        self.item_edit_group.setMaximumSize(QSize(800, 16777215))
        ...
        self.verticalLayout_7.addWidget(self.edit_item_text_format_button)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/add-document", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/trash-can", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/review-doc", QSize(), QIcon.Normal, QIcon.Off)
        self.doc_review_tool_button.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/level-sort", QSize(), QIcon.Normal, QIcon.Off)
        self.doc_reorder_level_tool_button.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/clear-text", QSize(), QIcon.Normal, QIcon.Off)
        self.item_tree_clear_search.setIcon(icon13)
