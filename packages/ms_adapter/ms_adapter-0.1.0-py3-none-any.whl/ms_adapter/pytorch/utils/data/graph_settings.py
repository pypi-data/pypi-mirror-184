...
# import ms_adapter.pytorch.utils.data.graph
# from ms_adapter.pytorch.utils.data.datapipes.iter import Shuffler
# import warnings
#
# __all__ = [
#     "apply_sharding",
...
#     graph = ms_adapter.pytorch.utils.data.graph.traverse(datapipe, only_datapipe=True)
