...
#
# import ms_adapter.pytorch.utils.data.backward_compatibility
#
# import ms_adapter.pytorch.utils.data.graph_settings
# from ms_adapter.pytorch.utils.data import DataLoader, IterDataPipe, communication
# from ms_adapter.pytorch.utils.data.datapipes.iter import IterableWrapper
#
# __all__ = [
#     "DataLoader2",
# ]
...
#             ms_adapter.pytorch.utils.data.graph_settings.apply_sharding(thread_localdatapipe, num_workers, worker_id)
#             thread.start()
...
#             datapipe = dataset
#             datapipe = ms_adapter.pytorch.utils.data.graph_settings.apply_shuffle_settings(datapipe, shuffle=shuffle)
...
#                         collate_fn = ms_adapter.pytorch.utils.data._utils.collate.default_collate
#
