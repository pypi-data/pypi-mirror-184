...
# import ms_adapter.pytorch.utils.data.graph_settings

from ms_adapter.pytorch._utils import ExceptionWrapper
...
# from ms_adapter.pytorch.utils.data.datapipes.datapipe import _IterDataPipeSerializationWrapper, _MapDataPipeSerializationWrapper
...
#     ms_adapter.pytorch.utils.data.graph_settings.apply_sharding(datapipe, total_workers, global_worker_id)
...
class DataLoader(Generic[T_co]):
    ...
    def __init__(self, dataset: Dataset[T_co], batch_size: Optional[int] = 1,
        ...
        #     else:
        #         ms_adapter.pytorch.utils.data.graph_settings.apply_sharding(self.dataset, ws, rank)
        ...
        if isinstance(dataset, IterableDataset):
            ...
            #         dataset = ms_adapter.pytorch.utils.data.graph_settings.apply_shuffle_settings(dataset, shuffle=shuffle)
...
class _BaseDataLoaderIter(object):
    def __init__(self, loader: DataLoader) -> None:
        ...
        #     self._dataset = ms_adapter.pytorch.utils.data.graph_settings.apply_shuffle_seed(self._dataset, shared_rng)
