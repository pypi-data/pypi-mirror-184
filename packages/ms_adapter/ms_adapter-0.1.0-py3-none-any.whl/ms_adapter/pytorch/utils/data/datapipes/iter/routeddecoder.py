...
from ms_adapter.pytorch.utils.data.datapipes.utils.common import _deprecation_warning
from ms_adapter.pytorch.utils.data.datapipes.utils.decoder import (
    Decoder,
