...
from ms_adapter.pytorch.utils.data.datapipes.datapipe import IterDataPipe, MapDataPipe
from ms_adapter.pytorch.utils.data.datapipes._typing import _DataPipeMeta
