...
from ms_adapter.pytorch.utils.data import Sampler, SequentialSampler
...
class ShufflerIterDataPipe(IterDataPipe[T_co]):
    ...
    When it is used with :class:`ms_adapter.pytorch.utils.data.DataLoader`, the methods to
    set up random seed are different based on :attr:`num_workers`.

    For single-process mode (:attr:`num_workers == 0`), the random seed is set before
    the :class:`~ms_adapter.pytorch.utils.data.DataLoader` in the main process. For multi-process
