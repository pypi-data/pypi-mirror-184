...
from ms_adapter.pytorch.utils.data.datapipes._decorator import functional_datapipe
from ms_adapter.pytorch.utils.data._utils.collate import default_collate
from ms_adapter.pytorch.utils.data.datapipes.datapipe import IterDataPipe
from ms_adapter.pytorch.utils.data.datapipes.utils.common import _check_lambda_fn
...
class CollatorIterDataPipe(MapperIterDataPipe):
    ...
    By default, it uses :func:`ms_adapter.pytorch.utils.data.default_collate`.

    .. note::
        While writing a custom collate function, you can import :func:`ms_adapter.pytorch.utils.data.default_collate` for the
    ...
    Example: Convert integer data to float Tensor
        >>> class MyIterDataPipe(ms_adapter.pytorch.utils.data.IterDataPipe):
