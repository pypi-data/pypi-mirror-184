...
from ms_adapter.pytorch.utils.data.datapipes._typing import _DataPipeMeta, _IterDataPipeMeta
from ms_adapter.pytorch.utils.data.datapipes.utils.common import (
    _deprecation_warning,
    _iter_deprecated_functional_names,
    _map_deprecated_functional_names,
)
from ms_adapter.pytorch.utils.data.dataset import Dataset, IterableDataset
