...
CSUR: set[tuple[int, int, str]] = {
    (60320, 60383, "Cistercian Numerals"),
    (58176, 58207, "Zirinka"),
    (60160, 60223, "Orokin"),
    (58848, 58879, "Ophidian"),
    (58880, 58927, "Ferengi"),
    (59248, 59263, "Solresol"),
    (58448, 58479, "Kazvarad"),
    (58704, 58751, "Alzetjan"),
    (59776, 59903, "Glaitha-B"),
    (59392, 59439, "Monofon"),
    (60064, 60159, "Wanya"),
    (60416, 60463, "Cylenian"),
    (58000, 58047, "Amman-Iar"),
    (57808, 57855, "Syai"),
    (59088, 59119, "Amlin"),
    (58288, 58367, "Olaetyan"),
    (58064, 58111, "Xaini"),
    (58512, 58559, "Rozhxh"),
    (58048, 58063, "Streich"),
    (58784, 58815, "Ssuraki"),
    (59264, 59391, "Visible Speech"),
    (59536, 59615, "Aurebesh"),
    (989440, 989695, "Sitelen Pona"),
    (57344, 57471, "Tengwar"),
    (59008, 59087, "Ewellic"),
    (59904, 60063, "Lhenazi"),
    (60672, 60735, "Deini"),
    (58624, 58655, "Saklor"),
    (60256, 60319, "Braille Extended"),
    (59440, 59535, "Dni"),
    (989952, 990271, "Shidinn"),
    (58752, 58783, "Telarasso"),
    (58928, 58959, "Seussian Latin Extensions"),
    (60736, 60799, "Niji"),
    (60464, 60527, "Syrrin"),
    (983040, 986735, "Kinya Syllables"),
    (58960, 59007, "Sylabica"),
    (59120, 59199, "Unifon Extended"),
    (58560, 58607, "Serivelna"),
    (58480, 58511, "Zarkhand"),
    (58208, 58239, "Sarkai"),
    (57856, 57967, "Verdurian"),
    (57776, 57807, "Ilianore"),
    (58656, 58703, "Rynnan"),
    (57968, 57999, "Aui"),
    (57600, 57679, "Engsvanyali"),
    (60224, 60255, "Standard Galactic"),
    (57472, 57599, "Cirth"),
    (60800, 60847, "Iranic"),
    (61312, 63647, "Private Use Area"),
    (58416, 58447, "Kazat Akkorou"),
    (59616, 59647, "Tonal"),
    (986736, 988847, "Pikto"),
    (60384, 60415, "Kaktovik Numerals"),
    (58368, 58415, "Niskloz"),
    (58816, 58847, "Gargoyle"),
    (63648, 63695, "Aiha"),
    (988928, 989439, "Semtog"),
    (59648, 59775, "Glaitha-A"),
    (58112, 58175, "Mizarian"),
    (58240, 58287, "Thelwik"),
    (63696, 63743, "Klingon"),
    (57680, 57775, "Kinya"),
    (58608, 58623, "Kelwathi"),
    (59200, 59247, "Unifon"),
}
"""
Set of the CSUR Unicode blocks; ``(start: int, end: int, name: str)``.
See https://www.evertype.com/standards/csur/ for details.
"""


BLOCKS_BYNAME: dict[str, tuple[int, int]] = {x[2]: (x[0], x[1]) for x in BLOCKS}
"""Dictionary of the Unicode blocks; ``{name}: (start, end)``."""

CSUR_BYNAME: dict[str, tuple[int, int]] = {x[2]: (x[0], x[1]) for x in CSUR}
"""Dictionary of the CSUR blocks; ``{name}: (start, end)``."""


def parse_blocks_txt(blocks_txt: str) -> set[tuple[int, int, str]]:
    """
