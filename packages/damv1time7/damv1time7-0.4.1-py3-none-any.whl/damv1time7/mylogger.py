                ...
                if (not '_argMarkSilentLogger' in kwargs) and (not '_argDiffMinSecondsSilentLogger_forUpdate' in kwargs):
                    ...
                    if bparam == True:
                        if MarkSilentLogger == True:
                            ...
                            bparam = mpl.kwargs().getValueAllowed(kwargs,'_argDiffMinSecondsSilentLogger_forUpdate',mpl.variable_type.float, 0)
                            print("CHECKING . . . type of _argDiffMinSecondsSilentLogger_forUpdate :", str(type(kwargs.get("_argDiffMinSecondsSilentLogger_forUpdate"))))
                            if bparam == True:
