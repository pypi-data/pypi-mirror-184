...
_AGGREGATION_FUNC_STR_TO_ENUM = {
    ...
    "firstn": AggregationFunction.AGGREGATION_FUNCTION_FIRST_NON_DISTINCT_N,
}
...
def _create_aggregate_features(
    ...
    elif feature.function == AggregationFunction.AGGREGATION_FUNCTION_FIRST_NON_DISTINCT_N:
