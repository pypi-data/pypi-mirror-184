...
def _make_last_n_partial(time_key: str, n: int):
...
AGGREGATION_PLANS = {
    ...
    afpb.AGGREGATION_FUNCTION_LAST_DISTINCT_N: lambda time_key, params, is_continuous: AggregationPlan(
        partial_aggregation_transform=_make_last_n_partial(time_key, params.last_n.n),
        full_aggregation_transform=_make_last_n_full(params.last_n.n),
        materialized_column_prefixes=[
