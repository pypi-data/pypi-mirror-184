...
class Notifier:
    ...
    def registry(
        ...
        """
        url = f"{self._service_url}/registry/{platform}/create?{self._service_credentials}"
        if jwt_token:
    ...
    def unregistry(
        ...
        """
        url = f"{self._service_url}/registry/unbind/{device_token}?{self._service_credentials}&platform={platform}"
        if jwt_token:
            url += f"{url}&token={jwt_token}"
