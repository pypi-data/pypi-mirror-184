import pytest
import privateprefs.internal.data_serializer as prefs
# noinspection PyProtectedMember
# from privateprefs.privateprefs import _path_to_test_file
# noinspection PyProtectedMember
# from privateprefs.internal.data_serializer import _save, _save_dict
...
def test_delete():
    prefs.save(test_key, test_value)
    prefs.save("other test key", "other test value")
