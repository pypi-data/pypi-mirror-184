...
requirements = ["uuid", "python-editor", "torch==1.13.1+cpu", "whisper-openai", "moviepy==2.0.0.dev2", "argparse", "srt", "auto-editor"] #  @ https://download.pytorch.org/whl/torch_stable.html
