...
import xmlparser.bytecode

import xmlparser.stringblock
import xmlparser.typeconstants as tc
from xmlparser.stringblock import StringBlock
from xmlparser.bytecode import SV
...
class AXMLParser:
    ...
    def __init__(self, raw_buff):
        ...
        self.buff = xmlparser.bytecode.BuffHandle(raw_buff)
