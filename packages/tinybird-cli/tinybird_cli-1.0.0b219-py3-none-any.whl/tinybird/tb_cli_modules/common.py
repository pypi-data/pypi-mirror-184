...
async def create_workspace_branch(ctx: Context, branch_name: Optional[str], last_partition: Optional[bool]):
    """
    ...
    try:
        ...
        await user_client.create_workspace_branch(branch_name, last_partition)  # type: ignore
