...
class TinyB(object):
    ...
    async def create_workspace_branch(self, branch_name: str, last_partition: Optional[bool]):
        params = {
            'name': branch_name,
        }
        if last_partition:
    ...
    async def branch_workspace_data(self, workspace_id: str, other_workspace: str, last_partition: Optional[str]):
