...
class Button(Item[V]):
    ...
    Parameters
    ----------
    style: :class:`versacord.ButtonStyle`
    ...
    def style(self) -> ButtonStyle:
        """:class:`versacord.ButtonStyle`: The style of the button."""
...
def button(
    *,
    ...
    the :class:`versacord.ui.View`, the :class:`versacord.ui.Button` being pressed and
    the :class:`versacord.Interaction` you receive.
