...
class Guild(Hashable):
    ...
    async def create_text_channel(
        ...
        *,
        ...
        .. code-block:: python3
            ...
            overwrites = {
                guild.default_role: versacord.PermissionOverwrite(read_messages=False),
                guild.me: versacord.PermissionOverwrite(read_messages=True)
            }
    ...
    def bans(
        ...
        *,
        ...
        """Returns an :class:`~versacord.AsyncIterator` that enables receiving the destination's bans.

        You must have the :attr:`~Permissions.ban_members` permission to get this information.

        .. versionchanged:: 2.0
            Due to a breaking change in Discord's API, this now returns an :class:`~versacord.AsyncIterator` instead of a :class:`list`.
        ...
        limit: Optional[:class:`int`]
            ...
            Defaults to 1000.
        before: Optional[:class:`~versacord.abc.Snowflake`]
            Retrieve bans before this user.
        after: Optional[:class:`~versacord.abc.Snowflake`]
    ...
    def audit_logs(
        ...
        *,
        ...
        Getting entries for a specific action: ::
            ...
            async for entry in guild.audit_logs(action=versacord.AuditLogAction.ban):
    ...
    async def edit_widget(
        ...
        channel: Optional[:class:`~versacord.abc.Snowflake`]
