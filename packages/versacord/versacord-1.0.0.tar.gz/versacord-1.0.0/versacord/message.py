...
class MessageReference:
    """Represents a reference to a :class:`~versacord.Message`.
    ...
    def from_message(cls, message: Message, *, fail_if_not_exists: bool = True) -> Self:
        """Creates a :class:`MessageReference` from an existing :class:`~versacord.Message`.
    ...
    def cached_message(self) -> Optional[Message]:
        """Optional[:class:`~versacord.Message`]: The cached message, if found in the internal message cache."""
...
class Message(Hashable):
    ...
    reference: Optional[:class:`~versacord.MessageReference`]
    ...
    async def create_thread(
        ...
        You must have :attr:`~versacord.Permissions.create_public_threads` in order to
    ...
    def to_reference(self, *, fail_if_not_exists: bool = True) -> MessageReference:
        """Creates a :class:`~versacord.MessageReference` from the current message.
        ...
        Returns
        -------
        :class:`~versacord.MessageReference`
...
class PartialMessage(Hashable):
    ...
    async def edit(self, **fields: Any) -> Optional[Message]:
        ...
        .. versionchanged:: 1.7
            :class:`versacord.Message` is returned instead of ``None`` if an edit took place.
