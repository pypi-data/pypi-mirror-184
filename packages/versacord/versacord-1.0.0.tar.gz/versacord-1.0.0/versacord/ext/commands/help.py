...
class HelpCommand:
    ...
    def __init__(self, **options):
        ...
        self.context: Context = versacord.utils.MISSING
    ...
    def get_max_size(self, commands):
        ...
        as_lengths = (versacord.utils.string_width(c.name) for c in commands)
        return max(as_lengths, default=0)

    def get_destination(self):
        """Returns the :class:`~versacord.abc.Messageable` where the help command will be output.
    ...
    async def command_callback(self, ctx, *, command=None):
        ...
        maybe_coro = versacord.utils.maybe_coroutine
...
class DefaultHelpCommand(HelpCommand):
    ...
    def add_indented_commands(self, commands, *, heading, max_size=None):
        ...
        get_width = versacord.utils.string_width
