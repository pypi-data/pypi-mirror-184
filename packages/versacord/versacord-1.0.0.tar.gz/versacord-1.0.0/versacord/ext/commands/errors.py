...
from versacord.errors import ClientException, DiscordException

if TYPE_CHECKING:
    from inspect import Parameter

    from versacord.abc import GuildChannel
    from versacord.threads import Thread
...
class CommandError(DiscordException):
    ...
    This inherits from :exc:`versacord.DiscordException`.
...
class ConversionError(CommandError):
    ...
    Attributes
    ----------
    converter: :class:`versacord.ext.commands.Converter`
...
class CommandRegistrationError(ClientException):
    ...
    This inherits from :exc:`versacord.ClientException`
...
class TooManyFlags(FlagError):
    ...
    Attributes
    ----------
    flag: :class:`~versacord.ext.commands.Flag`
