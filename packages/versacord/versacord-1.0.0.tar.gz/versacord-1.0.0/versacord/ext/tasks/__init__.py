...
import aiohttp
import versacord
from versacord.backoff import ExponentialBackoff
from versacord.utils import MISSING, utcnow
...
class SleepHandle:
    ...
    def __init__(self, dt: datetime.datetime, *, loop: asyncio.AbstractEventLoop) -> None:
        ...
        relative_delta = versacord.utils.compute_timedelta(dt)
...
class Loop(Generic[LF]):
    ...
    def __init__(
        ...
        self._valid_exception = (
            OSError,
            versacord.GatewayNotFound,
            versacord.ConnectionClosed,
            aiohttp.ClientError,
    ...
    def add_exception_type(self, *exceptions: Type[BaseException]) -> None:
        ...
        :meth:`versacord.Client.connect`\, which includes a lot of internet disconnection
        errors.
    ...
    def before_loop(self, coro: FT) -> FT:
        ...
        such as :meth:`versacord.Client.wait_until_ready`.
...
def loop(
    *,
    ...
    reconnect: :class:`bool`
        ...
        one used in :meth:`versacord.Client.connect`.
