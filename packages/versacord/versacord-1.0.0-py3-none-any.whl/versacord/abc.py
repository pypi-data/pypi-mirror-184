...
class User(Snowflake, Protocol):
    ...
    - :class:`~versacord.User`
    - :class:`~versacord.ClientUser`
    - :class:`~versacord.Member`

    This ABC must also implement :class:`~versacord.abc.Snowflake`.
...
class PrivateChannel(Snowflake, Protocol):
    ...
    - :class:`~versacord.DMChannel`
    - :class:`~versacord.GroupChannel`

    This ABC must also implement :class:`~versacord.abc.Snowflake`.

    Attributes
    ----------
    me: :class:`~versacord.ClientUser`
...
class GuildChannel:
    ...
    - :class:`~versacord.TextChannel`
    - :class:`~versacord.VoiceChannel`
    - :class:`~versacord.CategoryChannel`
    - :class:`~versacord.StageChannel`
    - :class:`~versacord.ForumChannel`
    ...
    def changed_roles(self) -> List[Role]:
        """List[:class:`~versacord.Role`]: Returns a list of roles that have been overridden from
        their default values in the :attr:`~versacord.Guild.roles` attribute."""
        ret = []
        g = self.guild
    ...
    def overwrites_for(self, obj: Union[Role, User]) -> PermissionOverwrite:
        ...
        Parameters
        ----------
        obj: Union[:class:`~versacord.Role`, :class:`~versacord.abc.User`]
            The role or user denoting
            whose overwrite to get.

        Returns
        -------
        :class:`~versacord.PermissionOverwrite`
    ...
    def overwrites(self) -> Dict[Union[Role, Member], PermissionOverwrite]:
        ...
        can be either a :class:`~versacord.Role` or a :class:`~versacord.Member` and the value is the
        overwrite as a :class:`~versacord.PermissionOverwrite`.

        Returns
        -------
        Dict[Union[:class:`~versacord.Role`, :class:`~versacord.Member`], :class:`~versacord.PermissionOverwrite`]
        ...
        for ow in self._overwrites:
            ...
            # i.e. adding versacord.Object to the list of it
    ...
    def category(self) -> Optional[CategoryChannel]:
        """Optional[:class:`~versacord.CategoryChannel`]: The category this channel belongs to.
    ...
    def permissions_for(self, obj: Union[Member, Role], /) -> Permissions:
        """Handles permission resolution for the :class:`~versacord.Member`
        or :class:`~versacord.Role`.
        ...
        If a :class:`~versacord.Role` is passed, then it checks the permissions
        ...
        Parameters
        ----------
        obj: Union[:class:`~versacord.Member`, :class:`~versacord.Role`]
    ...
    async def delete(self, *, reason: Optional[str] = None) -> None:
        ...
        You must have :attr:`~versacord.Permissions.manage_channels` permission to use this.
    ...
    async def set_permissions(
        ...
        **kwargs: Any,
        ...
        The ``target`` parameter should either be a :class:`~versacord.Member` or a
        :class:`~versacord.Role` that belongs to guild.

        The ``overwrite`` parameter, if given, must either be ``None`` or
        :class:`~versacord.PermissionOverwrite`. For convenience, you can pass in
        keyword arguments denoting :class:`~versacord.Permissions` attributes. If this is
        ...
        You must have the :attr:`~versacord.Permissions.manage_roles` permission to use this.
        ...
        Using :class:`~versacord.PermissionOverwrite` ::

            overwrite = versacord.PermissionOverwrite()
        ...
        Parameters
        ----------
        target: Union[:class:`~versacord.Member`, :class:`~versacord.Role`]
            The member or role to overwrite permissions for.
        overwrite: Optional[:class:`~versacord.PermissionOverwrite`]
        ...
        ~versacord.InvalidArgument
            The overwrite parameter invalid or the target type was not
            :class:`~versacord.Role` or :class:`~versacord.Member`.
        """
    ...
    async def clone(self, *, name: Optional[str] = None, reason: Optional[str] = None) -> Self:
        ...
        You must have the :attr:`~versacord.Permissions.manage_channels` permission to
        do this.
    ...
    async def move(self, **kwargs) -> None:
        ...
        before: :class:`~versacord.abc.Snowflake`
            The channel that should be before our current channel.
            This is mutually exclusive with ``beginning``, ``end``, and ``after``.
        after: :class:`~versacord.abc.Snowflake`
        ...
        category: Optional[:class:`~versacord.abc.Snowflake`]
    ...
    async def create_invite(
        ...
        *,
        ...
        You must have the :attr:`~versacord.Permissions.create_instant_invite` permission to
        do this.
    ...
    async def invites(self) -> List[Invite]:
        ...
        You must have :attr:`~versacord.Permissions.manage_channels` to get this information.
...
class Messageable:
    ...
    - :class:`~versacord.User`
    - :class:`~versacord.Member`
    - :class:`~versacord.ext.commands.Context`
    - :class:`~versacord.Thread`
    """
    ...
    async def send(
        ...
        *,
        ...
        single :class:`~versacord.File` object. To upload multiple files, the ``files``
        parameter should be used with a :class:`list` of :class:`~versacord.File` objects.
        **Specifying both parameters will lead to an exception**.

        To upload a single embed, the ``embed`` parameter should be used with a
        single :class:`~versacord.Embed` object. To upload multiple embeds, the ``embeds``
        parameter should be used with a :class:`list` of :class:`~versacord.Embed` objects.
        **Specifying both parameters will lead to an exception**.
        ...
        embed: :class:`~versacord.Embed`
            The rich embed for the content.
        file: :class:`~versacord.File`
            The file to upload.
        files: List[:class:`~versacord.File`]
        ...
        allowed_mentions: :class:`~versacord.AllowedMentions`
            Controls the mentions being processed in this message. If this is
            passed, then the object is merged with :attr:`~versacord.Client.allowed_mentions`.
            The merging behaviour only overrides attributes that have been explicitly passed
            to the object, otherwise it uses the attributes set in :attr:`~versacord.Client.allowed_mentions`.
            If no object is passed at all then the defaults given by :attr:`~versacord.Client.allowed_mentions`
            are used instead.

            .. versionadded:: 1.4

        reference: Union[:class:`~versacord.Message`, :class:`~versacord.MessageReference`, :class:`~versacord.PartialMessage`]
            A reference to the :class:`~versacord.Message` to which you are replying, this can be created using
            :meth:`~versacord.Message.to_reference` or passed directly as a :class:`~versacord.Message`. You can control
            whether this mentions the author of the referenced message using the :attr:`~versacord.AllowedMentions.replied_user`
            attribute of ``allowed_mentions`` or by setting ``mention_author``.

            .. versionadded:: 1.6

        mention_author: Optional[:class:`bool`]
            If set, overrides the :attr:`~versacord.AllowedMentions.replied_user` attribute of ``allowed_mentions``.

            .. versionadded:: 1.6
        view: :class:`versacord.ui.View`
            A Discord UI View to add to the message.
        embeds: List[:class:`~versacord.Embed`]
            A list of embeds to upload. Must be a maximum of 10.

            .. versionadded:: 2.0
        stickers: Sequence[Union[:class:`~versacord.GuildSticker`, :class:`~versacord.StickerItem`]]
        ...
        ~versacord.InvalidArgument
            ...
            or the ``reference`` object is not a :class:`~versacord.Message`,
            :class:`~versacord.MessageReference` or :class:`~versacord.PartialMessage`.

        Returns
        -------
        :class:`~versacord.Message`
    ...
    async def fetch_message(self, id: int, /) -> Message:
        ...
        Retrieves a single :class:`~versacord.Message` from the destination.
    ...
    def history(
        ...
        *,
        ...
        """Returns an :class:`~versacord.AsyncIterator` that enables receiving the destination's message history.

        You must have :attr:`~versacord.Permissions.read_message_history` permissions to use this.
        ...
        before: Optional[Union[:class:`~versacord.abc.Snowflake`, :class:`datetime.datetime`]]
            Retrieve messages before this date or message.
            If a datetime is provided, it is recommended to use a UTC aware datetime.
            If the datetime is naive, it is assumed to be local time.
        after: Optional[Union[:class:`~versacord.abc.Snowflake`, :class:`datetime.datetime`]]
            Retrieve messages after this date or message.
            If a datetime is provided, it is recommended to use a UTC aware datetime.
            If the datetime is naive, it is assumed to be local time.
        around: Optional[Union[:class:`~versacord.abc.Snowflake`, :class:`datetime.datetime`]]
    ...
    async def connect(
        ...
        *,
        ...
        cls: Type[:class:`VoiceProtocol`]
            A type that subclasses :class:`~versacord.VoiceProtocol` to connect with.
            Defaults to :class:`~versacord.VoiceClient`.

        Raises
        ------
        asyncio.TimeoutError
            Could not connect to the voice channel in time.
        ~versacord.ClientException
            You are already connected to a voice channel.
        ~versacord.opus.OpusNotLoaded
            The opus library has not been loaded.

        Returns
        -------
        :class:`~versacord.VoiceProtocol`
