...
class WebhookMessage(Message):
    ...
    This inherits from :class:`versacord.Message` with changes to
...
class Webhook(BaseWebhook):
    ...
    async def send(
        ...
        *,
        ...
        view: :class:`versacord.ui.View`
            ...
            .. versionadded:: 2.0
        thread: :class:`~versacord.abc.Snowflake`
    ...
    async def fetch_message(self, id: int) -> WebhookMessage:
        ...
        Retrieves a single :class:`~versacord.WebhookMessage` owned by this webhook.
        ...
        Returns
        -------
        :class:`~versacord.WebhookMessage`
