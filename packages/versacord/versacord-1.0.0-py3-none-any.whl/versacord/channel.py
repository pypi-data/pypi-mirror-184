...
class TextChannel(abc.Messageable, abc.GuildChannel, Hashable, PinsMixin):
    ...
    async def create_thread(
        ...
        *,
        ...
        To create a public thread, you must have :attr:`~versacord.Permissions.create_public_threads`.
        For a private thread, :attr:`~versacord.Permissions.create_private_threads` is needed instead.
    ...
    def archived_threads(
        ...
        *,
        ...
        """Returns an :class:`~versacord.AsyncIterator` that iterates over all archived threads in the guild.
...
class ForumChannel(abc.GuildChannel, Hashable):
    ...
    async def create_thread(
        ...
        *,
        ...
        :attr:`~versacord.Permissions.create_public_threads`.
        For a private thread, :attr:`~versacord.Permissions.create_private_threads`
        is needed instead.
        ...
        embed: Optional[:class:`~versacord.Embed`]
            The rich embed for the content.
        embeds: Optional[List[:class:`~versacord.Embed`]]
            A list of rich embeds for the content.
        file: :class:`~versacord.File`
            The file to upload.
        files: Optional[List[:class:`~versacord.File`]]
            A list of files to upload. Must be a maximum of 10.
        nonce: Optional[:class:`int`]
            The nonce to use for sending this message. If the message was successfully sent,
            then the message will have a nonce with this value.
        allowed_mentions: Optional[:class:`~versacord.AllowedMentions`]
        ...
        view: Optional[:class:`~versacord.ui.View`]
            The view to send with the message.
        stickers: Optional[Sequence[Union[:class:`~versacord.GuildSticker`, :class:`~versacord.StickerItem`]]]
