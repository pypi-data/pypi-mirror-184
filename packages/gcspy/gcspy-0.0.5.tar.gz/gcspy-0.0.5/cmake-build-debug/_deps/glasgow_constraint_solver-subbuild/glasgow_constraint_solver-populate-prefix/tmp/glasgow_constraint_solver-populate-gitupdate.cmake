...
execute_process(
  COMMAND "/usr/bin/git" show-ref "8638a1eb4b371b5514615b0f7fd9b98d2466c713"
  WORKING_DIRECTORY "/Users/matthewmcilree/PhD_Code/gcspy/cmake-build-debug/_deps/glasgow_constraint_solver-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "8638a1eb4b371b5514615b0f7fd9b98d2466c713")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("8638a1eb4b371b5514615b0f7fd9b98d2466c713" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/8638a1eb4b371b5514615b0f7fd9b98d2466c713")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/matthewmcilree/PhD_Code/gcspy/cmake-build-debug/_deps/glasgow_constraint_solver-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/matthewmcilree/PhD_Code/gcspy/cmake-build-debug/_deps/glasgow_constraint_solver-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
