...
'''
def get_params(bfm_path, param_path):
    #with open("configs/bfm_noneck_v3.pkl",'rb') as f:
    ...
    #with open("configs/param_mean_std_62d_120x120.pkl",'rb') as f:
    ...
    return param_mean,param_std,u_base,w_shp_base,w_exp_base
'''
