...
link_args = []
files = ["omp.h","fcwt.h","fftw3.h","fftw3f.dll","fftw3f.lib","libomp.a"]

if "macosx" in sysconfig.get_platform() or "darwin" in sysconfig.get_platform():
    libraries = ['fftw3fmac','fftw3f_ompmac']
    comp_args = ["-mavx","-O3"]
    link_args = ["-lomp"]
    files = ["omp.h","fcwt.h","fftw3.h","libfftw3fmac.a","libfftw3f_ompmac.a","libomp.a"]

if "linux" in sysconfig.get_platform():
    libraries = ['fftw3fl','fftw3f_ompl']
    comp_args = ["-mavx","-O3"]
    link_args = ["-lomp"]
    files = ["omp.h","fcwt.h","fftw3.h","libfftw3fl.so","libfftw3f_ompl.so","libomp.a"]
